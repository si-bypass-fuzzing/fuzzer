...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'c7a65397');
		...
		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.2:8080/input-8343_page-2.html#5b867cce');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.1:8080/input-8343_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.2:8080/input-8343_page-1.html');
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'c09bd5de');
		...
		try {
			var func1_var3 = self.registration.cookies;
		} catch (e) {console.log(e)}

		try {
			var func1_var4 = await func1_var3.getSubscriptions();
		} catch (e) {console.log(e)}

		try {
			var func1_var5 = 'http://127.0.0.1:8080/input-8343_page-2.html#080589cd';
		} catch (e) {console.log(e)}
		...
		try {
			func1_var2.cancelBubble = func1_var7;
		} catch (e) {console.log(e)}
		...
		try {
			var func1_var11 = new Array(func1_var10);
		} catch (e) {console.log(e)}

		try {
			var func1_var9 = {topOrigin: func1_var0, paymentRequestOrigin: func1_var0, methodData: func1_var11, modifiers: func1_var11, };
		} catch (e) {console.log(e)}

		try {
			var func1_var12 = new CanMakePaymentEvent(func1_var8,func1_var9);
		} catch (e) {console.log(e)}

		try {
			var func1_var13 = await func1_var12.stopImmediatePropagation();
		} catch (e) {console.log(e)}
		...
		try {
			var func1_var16 = 'http://127.0.0.2:8080/input-8343_page-2.html#5e8ee984';
		} catch (e) {console.log(e)}

		try {
			var func1_var17 = new FetchEvent(func1_var16,func1_var6);
		} catch (e) {console.log(e)}

		try {
			var func1_var18 = true;
		} catch (e) {console.log(e)}

		try {
			func1_var17.cancelBubble = func1_var18;
		} catch (e) {console.log(e)}
		...
		try {
			var func1_var20 = new BackgroundFetchUpdateUIEvent(func1_var19,func1_var15);
		} catch (e) {console.log(e)}

		try {
			var func1_var21 = await func1_var20.waitUntil(func1_var4);
		} catch (e) {console.log(e)}

		try {
			var func1_var22 = await func1_var20.composedPath();
		} catch (e) {console.log(e)}

		try {
			var func1_var23 = await func1_var3.unsubscribe(func1_var4);
		} catch (e) {console.log(e)}

		try {
			var func1_var24 = 'http://127.0.0.2:8080/input-8343_page-2.html#ddc58fc6';
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.2:8080/input-8343_page-2.html');
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'fdd4905f');
		...
		try {
			var func2_var2 = 'http://127.0.0.1:8080/input-8343_page-1.html#0187613f';
		} catch (e) {console.log(e)}

		try {
			var func2_var3 = new FetchEvent(func2_var2,func2_var1);
		} catch (e) {console.log(e)}

		try {
			var func2_var4 = await func2_var3.stopImmediatePropagation();
		} catch (e) {console.log(e)}

		try {
			var func2_var5 = 'http://127.0.0.1:8080/input-8343_page-1.html#3ee1c4b3';
		} catch (e) {console.log(e)}
		...
		try {
			var func2_var10 = {tag: func2_var0, };
		} catch (e) {console.log(e)}

		try {
			var func2_var11 = new SyncEvent(func2_var9,func2_var10);
		} catch (e) {console.log(e)}

		try {
			var func2_var12 = true;
		} catch (e) {console.log(e)}

		try {
			func2_var11.cancelBubble = func2_var12;
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.1:8080/input-8343_page-2.html');
		} catch (e) {console.log(e)}
		...
		try {
			var func2_var14 = new PushSubscriptionChangeEvent(func2_var13);
		} catch (e) {console.log(e)}

		try {
			var func2_var15 = await func2_var14.composedPath();
		} catch (e) {console.log(e)}

		try {
			var func2_var16 = 'http://127.0.0.2:8080/input-8343_page-2.html#94c86ee6';
		} catch (e) {console.log(e)}

		try {
			var func2_var17 = {data: func2_var0, };
		} catch (e) {console.log(e)}

		try {
			var func2_var18 = new PushEvent(func2_var16,func2_var17);
		} catch (e) {console.log(e)}

		try {
			var func2_var19 = await func2_var18.stopImmediatePropagation();
		} catch (e) {console.log(e)}
		...
		try {
			var func2_var22 = new InstallEvent(func2_var20,func2_var21);
		} catch (e) {console.log(e)}

		try {
			var func2_var23 = await func2_var22.stopImmediatePropagation();
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-8343_page-2.html#1e4ce3ef');
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'c687e145');
		...
		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.1:8080/input-8343_page-2.html');
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var2 = {topOrigin: func3_var1, methodData: func3_var3, modifiers: func3_var3, };
		} catch (e) {console.log(e)}

		try {
			var func3_var4 = new CanMakePaymentEvent(func3_var1,func3_var2);
		} catch (e) {console.log(e)}
		...
		try {
			func3_var4.returnValue = func3_var5;
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.2:8080/input-8343_page-2.html#a2ba2925');
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var7 = {tag: func3_var1, lastChance: func3_var5, };
		} catch (e) {console.log(e)}

		try {
			var func3_var8 = new SyncEvent(func3_var6,func3_var7);
		} catch (e) {console.log(e)}
		...
		try {
			func3_var8.cancelBubble = func3_var9;
		} catch (e) {console.log(e)}

		try {
			var func3_var10 = await func3_var4.stopPropagation();
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.2:8080/input-8343_page-1.html');
		} catch (e) {console.log(e)}

		try {
			var func3_var12 = 'worker';
		} catch (e) {console.log(e)}

		try {
			var func3_var11 = {includeUncontrolled: func3_var5, type: func3_var12, };
		} catch (e) {console.log(e)}

		try {
			var func3_var13 = await self.clients.matchAll(func3_var11);
		} catch (e) {console.log(e)}

		try {
			var func3_var14 = 'http://127.0.0.1:8080/input-8343_page-2.html#a13a9310';
		} catch (e) {console.log(e)}

		try {
			var func3_var15 = await self.serviceWorker.on(func3_var14);
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var16 = await func3_var8.stopImmediatePropagation();
		} catch (e) {console.log(e)}

		try {
			var func3_var17 = false;
		} catch (e) {console.log(e)}

		try {
			event.cancelBubble = func3_var17;
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-8e46e414] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-a117fef0] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'e3e8ad4e');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('data:blank');
		} catch (e) {console.log(e)}

		try {
			var func4_var0 = 'data:text/plain,foo';
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.2:8080/input-8343_page-1.html#3a5ebb28');
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var7 = await self.cookieStore.addEventListener(func4_var5,func4_var6,self.isSecureContext);
		} catch (e) {console.log(e)}

		try {
			var func4_var8 = 'http://127.0.0.2:8080/input-8343_page-2.html#d8423463';
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var10 = new PushEvent(func4_var8,func4_var9);
		} catch (e) {console.log(e)}
		...
		try {
			func4_var10.cancelBubble = func4_var11;
		} catch (e) {console.log(e)}

		try {
			var func4_var12 = 'http://127.0.0.2:8080/input-8343_page-1.html#b25a19fd';
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var14 = new Promise(eval);
		} catch (e) {console.log(e)}

		try {
			var func4_var15 = await func4_var3.waitUntil(func4_var14);
		} catch (e) {console.log(e)}

		try {
			var func4_var16 = await event.stopImmediatePropagation();
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.1:8080/input-8343_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-8343_page-2.html#dffd0bc7');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.1:8080/input-8343_page-1.html');
		} catch (e) {console.log(e)}
		...
		try {
			event.respondWith(fetch('http://127.0.0.2:8080/input-8343_page-2.html#7dc76bec').then((resp) => {if (resp.ok) {return resp;} else {return fetch(event.request);}}).catch((err) => {return fetch(event.request);}));
		} catch (e) {console.log(e)}
	}
	try {
		self.onfetch = func4;
