...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'b3a62523');
		...
		try {
			var func0_var3 = new BackgroundFetchEvent(func0_var2,func0_var1);
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var6 = {changed: func0_var7, deleted: func0_var7, };
		} catch (e) {console.log(e)}

		try {
			var func0_var8 = new ExtendableCookieChangeEvent(func0_var5,func0_var6);
		} catch (e) {console.log(e)}

		try {
			var func0_var9 = await func0_var8.preventDefault();
		} catch (e) {console.log(e)}

		try {
			var func0_var10 = 'http://127.0.0.1:8080/input-8337_page-2.html#c03a3ff2';
		} catch (e) {console.log(e)}

		try {
			var func0_var11 = {id: func0_var0, };
		} catch (e) {console.log(e)}

		try {
			var func0_var12 = new ContentIndexEvent(func0_var10,func0_var11);
		} catch (e) {console.log(e)}

		try {
			var func0_var13 = new Promise(eval);
		} catch (e) {console.log(e)}

		try {
			var func0_var14 = await func0_var12.waitUntil(func0_var13);
		} catch (e) {console.log(e)}

		try {
			var func0_var15 = await func0_var12.composedPath();
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'f9538596');
		...
		try {
			var func1_var4 = new PushSubscriptionChangeEvent(func1_var2,func1_var3);
		} catch (e) {console.log(e)}
		...
		try {
			func1_var4.returnValue = func1_var5;
		} catch (e) {console.log(e)}
		...
		try {
			var func1_var7 = await self.cookieStore.addEventListener(func1_var6,null,func1_var5);
		} catch (e) {console.log(e)}
		...
		try {
			func1_var4.returnValue = func1_var8;
		} catch (e) {console.log(e)}
		...
		try {
			var func1_var10 = {id: func1_var0, };
		} catch (e) {console.log(e)}

		try {
			var func1_var11 = new ContentIndexEvent(func1_var9,func1_var10);
		} catch (e) {console.log(e)}

		try {
			var func1_var12 = await func1_var11.composedPath();
		} catch (e) {console.log(e)}

		try {
			var func1_var13 = new Promise(eval);
		} catch (e) {console.log(e)}

		try {
			var func1_var14 = await func1_var4.waitUntil(func1_var13);
		} catch (e) {console.log(e)}

		try {
			var func1_var15 = await func1_var11.preventDefault();
		} catch (e) {console.log(e)}

		try {
			var func1_var16 = undefined;
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '437f185a');
		...
		try {
			var func2_var5 = {currency: func2_var0, value: func2_var0, };
		} catch (e) {console.log(e)}
		...
		try {
			var func2_var23 = new PushSubscriptionChangeEvent(func2_var21,func2_var22);
		} catch (e) {console.log(e)}

		try {
			var func2_var24 = await func2_var23.composedPath();
		} catch (e) {console.log(e)}

		try {
			var func2_var25 = await func2_var2.stopPropagation();
		} catch (e) {console.log(e)}

		try {
			var func2_var26 = 'http://127.0.0.1:8080/input-8337_page-1.html#8e50b1bc';
		} catch (e) {console.log(e)}

		try {
			var func2_var27 = {data: event, origin: func2_var0, lastEventId: func2_var0, source: self.serviceWorker, ports: func2_var7, };
		} catch (e) {console.log(e)}

		try {
			var func2_var28 = new ExtendableMessageEvent(func2_var26,func2_var27);
		} catch (e) {console.log(e)}

		try {
			var func2_var29 = await func2_var28.composedPath();
		} catch (e) {console.log(e)}

		try {
			var func2_var30 = await func2_var2.preventDefault();
		} catch (e) {console.log(e)}

		try {
			var func2_var31 = 'http://127.0.0.2:8080/input-8337_page-1.html#8c42c85a';
		} catch (e) {console.log(e)}

		try {
			var func2_var32 = false;
		} catch (e) {console.log(e)}

		try {
			var func2_var33 = true;
		} catch (e) {console.log(e)}

		try {
			var func2_var34 = await func2_var2.initEvent(func2_var31,func2_var32,func2_var33);
		} catch (e) {console.log(e)}

		try {
			var func2_var35 = await func2_var18.preventDefault();
		} catch (e) {console.log(e)}

		try {
			var func2_var36 = 'http://127.0.0.2:8080/input-8337_page-2.html#f296a96b';
		} catch (e) {console.log(e)}

		try {
			var func2_var37 = true;
		} catch (e) {console.log(e)}

		try {
			var func2_var38 = await func2_var2.initEvent(func2_var36,func2_var37);
		} catch (e) {console.log(e)}

		try {
			var func2_var39 = 'http://127.0.0.1:8080/input-8337_page-2.html#2a8371c4';
		} catch (e) {console.log(e)}

		try {
			var func2_var40 = new USBConnectionEvent(func2_var39,func2_var13);
		} catch (e) {console.log(e)}

		try {
			var func2_var41 = undefined;
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '4010e99c');

		} catch (e) {console.log(e)}

		try {
			var func3_var0 = 'http://127.0.0.1:8080/input-8337_page-1.html#7e56e186';
		} catch (e) {console.log(e)}

async function func3_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, '94f718f3');

			} catch (e) {console.log(e)}

			try {
				var func3_func0_var0 = event.data;
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var1 = await func3_func0_var0.text();
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var2 = 'http://127.0.0.2:8080/input-8337_page-1.html#47135e30';
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var3 = {tag: func3_func0_var1, lastChance: self.isSecureContext, };
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var4 = new SyncEvent(func3_func0_var2,func3_func0_var3);
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var5 = await func3_func0_var4.stopPropagation();
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var6 = '8bf18cb9455f4a8e8fa93d14ab5ebb5d';
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var8 = await event.stopImmediatePropagation();
			} catch (e) {console.log(e)}
			...
			try {
				var func3_func0_var11 = await func3_func0_var4.composedPath();
			} catch (e) {console.log(e)}
			...
			try {
				var func3_func0_var14 = await func3_func0_var4.stopPropagation();
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var15 = self.navigator.usb;
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var16 = await func3_func0_var15.getDevices();
			} catch (e) {console.log(e)}
			...
			try {
				var func3_func0_var18 = await self.serviceWorker.on(func3_func0_var17);
			} catch (e) {console.log(e)}

			try {
				func3_func0_var15.onconnect = eval;
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var19 = await func3_func0_var0.arrayBuffer();
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var20 = 'http://127.0.0.2:8080/input-8337_page-2.html#1f01430d';
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var21 = await self.cookieStore.on(func3_func0_var20);
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var22 = '8bf18cb9455f4a8e8fa93d14ab5ebb5d';
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var24 = {currency: func3_func0_var1, value: func3_func0_var1, };
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var26 = 'shipping';
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var25 = {requestPayerName: self.isSecureContext, requestPayerEmail: self.isSecureContext, requestPayerPhone: self.isSecureContext, requestShipping: self.isSecureContext, shippingType: func3_func0_var26, };
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var23 = {topOrigin: func3_func0_var1, paymentRequestOrigin: func3_func0_var1, paymentRequestId: func3_func0_var1, methodData: func3_func0_var11, total: func3_func0_var24, modifiers: func3_func0_var11, instrumentKey: func3_func0_var1, paymentOptions: func3_func0_var25, shippingOptions: func3_func0_var11, };
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var27 = new PaymentRequestEvent(func3_func0_var22,func3_func0_var23);
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var28 = await func3_func0_var27.stopImmediatePropagation();
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var29 = self.registration.cookies;
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var30 = await func3_func0_var29.getSubscriptions();
			} catch (e) {console.log(e)}
			...
			try {
				var func3_func0_var31 = await func3_func0_var21.subscribe('');
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var32 = undefined;
			} catch (e) {console.log(e)}

			return func3_func0_var32;
		}
		...
		try {
			var func3_var2 = await self.addEventListener(func3_var0,func3_var1,self.isSecureContext);
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var5 = new AbortPaymentEvent(func3_var3,func3_var4);
		} catch (e) {console.log(e)}

		try {
			var func3_var6 = await func3_var5.stopImmediatePropagation();
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var8 = new InstallEvent(func3_var7,func3_var4);
		} catch (e) {console.log(e)}

		try {
			var func3_var9 = new Promise(eval);
		} catch (e) {console.log(e)}

		try {
			var func3_var10 = await func3_var8.waitUntil(func3_var9);
		} catch (e) {console.log(e)}

async function func3_func1(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, 'd0ea819e');

			} catch (e) {console.log(e)}

			try {
				var func3_func1_var0 = await event.preventDefault();
			} catch (e) {console.log(e)}

			try {
				var func3_func1_var1 = false;
			} catch (e) {console.log(e)}

			try {
				func3_var8.cancelBubble = func3_func1_var1;
			} catch (e) {console.log(e)}
			...
			try {
				var func3_func1_var2 = await func3_var5.preventDefault();
			} catch (e) {console.log(e)}

			try {
				var func3_func1_var3 = false;
			} catch (e) {console.log(e)}

			try {
				event.cancelBubble = func3_func1_var3;
			} catch (e) {console.log(e)}

			try {
				var func3_func1_var4 = 'http://127.0.0.1:8080/input-8337_page-2.html#36234f90';
			} catch (e) {console.log(e)}

			try {
				var func3_func1_var5 = true;
			} catch (e) {console.log(e)}

			try {
				var func3_func1_var6 = false;
			} catch (e) {console.log(e)}

			try {
				var func3_func1_var7 = await func3_var5.initEvent(func3_func1_var4,func3_func1_var5,func3_func1_var6);
			} catch (e) {console.log(e)}

			try {
				var func3_func1_var8 = undefined;
			} catch (e) {console.log(e)}

			return func3_func1_var8;
		}

		try {
			self.onperiodicsync = func3_func1;
		} catch (e) {console.log(e)}

		try {
			var func3_var11 = true;
		} catch (e) {console.log(e)}

		try {
			func3_var8.returnValue = func3_var11;
		} catch (e) {console.log(e)}
		...
		try {
			event.returnValue = func3_var12;
		} catch (e) {console.log(e)}

		try {
			var func3_var13 = await event.stopImmediatePropagation();
		} catch (e) {console.log(e)}

		try {
			var func3_var14 = undefined;
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-f94149d7] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-52ade482] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			var func4_var6 = new Array(func4_var5);
		} catch (e) {console.log(e)}

		try {
			var func4_var4 = {topOrigin: func4_var0, paymentRequestOrigin: func4_var0, modifiers: func4_var6, };
		} catch (e) {console.log(e)}

		try {
			var func4_var7 = new CanMakePaymentEvent(func4_var3,func4_var4);
		} catch (e) {console.log(e)}

		try {
			var func4_var8 = await func4_var7.stopPropagation();
		} catch (e) {console.log(e)}

		try {
			var func4_var9 = self.registration.cookies;
		} catch (e) {console.log(e)}

		try {
			var func4_var10 = await func4_var9.subscribe(func4_var6);
		} catch (e) {console.log(e)}

		try {
			var func4_var11 = 'http://127.0.0.2:8080/input-8337_page-1.html#32a7bae4';
		} catch (e) {console.log(e)}

		try {
			var func4_var12 = {tag: func4_var0, };
		} catch (e) {console.log(e)}

		try {
			var func4_var13 = new PeriodicSyncEvent(func4_var11,func4_var12);
		} catch (e) {console.log(e)}

		try {
			var func4_var14 = await func4_var13.composedPath();
		} catch (e) {console.log(e)}

		try {
			var func4_var15 = true;
		} catch (e) {console.log(e)}

		try {
			event.returnValue = func4_var15;
		} catch (e) {console.log(e)}

		try {
			var func4_var16 = '8bf18cb9455f4a8e8fa93d14ab5ebb5d';
		} catch (e) {console.log(e)}

		try {
			var func4_var19 = 'http://127.0.0.1:8080/input-8337_page-2.html#1a45d8a9';
		} catch (e) {console.log(e)}

		try {
			var func4_var18 = await self.clients.openWindow(func4_var19);
		} catch (e) {console.log(e)}

		try {
			var func4_var20 = await func4_var18.focus();
		} catch (e) {console.log(e)}

		try {
			var func4_var22 = 'http://127.0.0.1:8080/input-8337_page-2.html#e016e8b4';
		} catch (e) {console.log(e)}

		try {
			var func4_var23 = new NotificationEvent(func4_var22,func4_var17);
		} catch (e) {console.log(e)}

		try {
			var func4_var24 = true;
		} catch (e) {console.log(e)}

		try {
			func4_var23.cancelBubble = func4_var24;
		} catch (e) {console.log(e)}

		try {
			var func4_var25 = {name: func4_var0, url: func4_var0, };
		} catch (e) {console.log(e)}

		try {
			var func4_var26 = await self.cookieStore.getAll(func4_var25);
		} catch (e) {console.log(e)}

		try {
			var func4_var27 = 'http://127.0.0.2:8080/input-8337_page-1.html#6a9657f4';
		} catch (e) {console.log(e)}

		try {
			var func4_var28 = await self.clients.openWindow(func4_var27);
		} catch (e) {console.log(e)}

		try {
			var func4_var29 = await func4_var9.subscribe(func4_var6);
		} catch (e) {console.log(e)}

		try {
			var func4_var30 = 'http://127.0.0.2:8080/input-8337_page-1.html#1b83a8f3';
		} catch (e) {console.log(e)}

		try {
			var func4_var31 = await func4_var18.navigate(func4_var30);
		} catch (e) {console.log(e)}

		try {
			var func4_var32 = await self.clients.claim();
		} catch (e) {console.log(e)}

		try {
			var func4_var33 = undefined;
		} catch (e) {console.log(e)}
