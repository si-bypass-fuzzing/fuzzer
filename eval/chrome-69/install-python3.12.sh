...
sudo LDFLAGS="${LDFLAGS} -Wl,-rpath=/opt/openssl-1.1.1/lib" CFLAGS="${CFLAGS} -I/opt/openssl-1.1.1/include" ./configure --with-openssl=/opt/openssl-1.1.1/ --prefix=/opt/python/3.12.2/
sudo make -j "$(nproc)"
