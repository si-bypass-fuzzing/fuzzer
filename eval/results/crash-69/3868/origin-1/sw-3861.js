...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '9787102c');
...
async function func0_func0(event) {
			...
			try {
				var func0_func0_var2 = 'http://127.0.0.2:8080/input-3861_page-2.html#387978e9';
			} catch (e) {console.log(e)}
			...
			try {
				IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.1:8080/input-3861_page-2.html');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-3861_page-2.html#5635891c');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-3861_page-2.html#3ff9a9d2');
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var4 = 78;
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var5 = new Array(func0_func0_var4);
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var6 = await func0_func0_var1.postMessage(event,func0_func0_var5);
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_origin_replace_host('http://127.0.0.2:8080/input-3861_page-1.html');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-3861_page-1.html#5e4910d6');
			} catch (e) {console.log(e)}
			...
			try {
				event.returnValue = func0_func0_var7;
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var8 = undefined;
			} catch (e) {console.log(e)}

			return func0_func0_var8;
		}
		...
		try {
			var func0_var6 = await event.waitUntil(func0_var1);
		} catch (e) {console.log(e)}

async function func0_func1(event) {
			try {
				check_site_violation('http://127.0.0.1:8080', location.origin, '6e6c1929');
			...
			try {
				IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.1:8080/input-3861_page-1.html');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-3861_page-2.html#13026361');
			} catch (e) {console.log(e)}

			try {
				var func0_func1_var0 = await event.stopImmediatePropagation();
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_storage_key('http://127.0.0.1:8080/input-3861_page-2.html#e90e4f7c');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_site_for_cookies('http://127.0.0.2:8080/input-3861_page-2.html#29a7d39f');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.2:8080/input-3861_page-2.html');
			} catch (e) {console.log(e)}

			try {
				var func0_func1_var1 = 'foo';
			} catch (e) {console.log(e)}

			try {
				var func0_func1_var2 = await self.cookieStore.addEventListener(func0_func1_var1,func0_var3,'');
			} catch (e) {console.log(e)}

			try {
				var func0_func1_var3 = undefined;
			} catch (e) {console.log(e)}

			return func0_func1_var3;
		}

		try {
			self.onpushsubscriptionchange = func0_func1;
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '3c4a4eb3');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.1:8080/input-3861_page-2.html');
		} catch (e) {console.log(e)}
		...
		try {
			var func1_var1 = await self.clearTimeout(func1_var0);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.1:8080/input-3861_page-1.html');
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '0201c897');

		} catch (e) {console.log(e)}

		try {
			var func3_var1 = 'strict';
		} catch (e) {console.log(e)}

		try {
			var func3_var0 = {name: self.origin, path: self.origin, sameSite: func3_var1, };
		} catch (e) {console.log(e)}

		try {
			var func3_var2 = await self.cookieStore.delete(func3_var0);
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var5 = await self.cookieStore.dispatchEvent(event);
		} catch (e) {console.log(e)}

		try {
			var func3_var6 = await event.waitUntil(func3_var2);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.1:8080/input-3861_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-3861_page-1.html#6260df59');
		} catch (e) {console.log(e)}

		try {
			var func3_var7 = await event.composedPath();
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-3861_page-1.html#c71e5ff1');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.2:8080/input-3861_page-2.html#618c75b5');
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-46e36c3e] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-23ba501c] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
