...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '83246734');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.2:8080/input-3863_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.2:8080/input-3863_page-1.html');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.2:8080/input-3863_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.1:8080/input-3863_page-1.html#0643fae9');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.2:8080/input-3863_page-1.html');
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var3 = await self.clients.get(func0_var2);
		} catch (e) {console.log(e)}
...
async function func0_func0(event) {
			try {
				check_site_violation('http://127.0.0.1:8080', location.origin, 'dabff453');

			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_url('http://127.0.0.2:8080/input-3863_page-2.html#a55ab60a');
			} catch (e) {console.log(e)}
			...
			try {
				IPCFuzzer.mutate_url('http://127.0.0.1:8080/input-3863_page-1.html#14f4f3c0');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.1:8080/input-3863_page-1.html');
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var2 = 'http://127.0.0.1:8080/input-3863_page-1.html#dc05ab48';
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var1 = await self.clients.openWindow(func0_func0_var2);
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var3 = 'http://127.0.0.2:8080/input-3863_page-2.html#ed93507e';
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var4 = await func0_func0_var1.navigate(func0_func0_var3);
			} catch (e) {console.log(e)}
			...
			try {
				var func0_func0_var5 = await func0_func0_var1.postMessage(event,func0_func0_var0);
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_url('http://127.0.0.2:8080/input-3863_page-2.html#04394a19');
			} catch (e) {console.log(e)}
			...
			try {
				event.returnValue = func0_func0_var6;
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.1:8080/input-3863_page-2.html');
			} catch (e) {console.log(e)}
		...
		try {
			var func0_var5 = {handleEvent: func0_func0};
		} catch (e) {console.log(e)}

		try {
			var func0_var6 = await self.cookieStore.addEventListener(func0_var4,func0_var5,'');
		} catch (e) {console.log(e)}

		try {
			var func0_var8 = 'http://127.0.0.1:8080/input-3863_page-2.html#d8db9300';
		} catch (e) {console.log(e)}

		try {
			var func0_var7 = await self.clients.openWindow(func0_var8);
		} catch (e) {console.log(e)}

		try {
			var func0_var9 = await func0_var7.focus();
		} catch (e) {console.log(e)}

		try {
			var func0_var10 = await event.composedPath();
		} catch (e) {console.log(e)}

		try {
			var func0_var11 = await self.cookieStore.getChangeSubscriptions();
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '3345b6ea');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.2:8080/input-3863_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.1:8080/input-3863_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.2:8080/input-3863_page-2.html');
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '89f2d1bc');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-3863_page-1.html#c8b2b96d');
		} catch (e) {console.log(e)}
...
async function func2_func0(event) {
			try {
				check_site_violation('http://127.0.0.1:8080', location.origin, '62a423ab');

			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.2:8080/input-3863_page-2.html');
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var0 = '5734';
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var1 = await self.clients.get(func2_func0_var0);
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-3863_page-2.html#8d885d15');
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var3 = true;
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var2 = {includeUncontrolled: func2_func0_var3, };
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var4 = await self.clients.matchAll(func2_func0_var2);
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-3863_page-2.html');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-3863_page-2.html#1d822396');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-3863_page-1.html#c49879a8');
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var5 = false;
			} catch (e) {console.log(e)}

			try {
				event.returnValue = func2_func0_var5;
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var6 = undefined;
			} catch (e) {console.log(e)}

			return func2_func0_var6;
		}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '75db90d7');
		...
		try {
			IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-3863_page-1.html#ab267b12');
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var2 = 'http://127.0.0.1:8080/input-3863_page-2.html#2dea9a06';
		} catch (e) {console.log(e)}

		try {
			var func3_var3 = await self.clients.openWindow(func3_var2);
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var5 = await self.clients.get(func3_var4);
		} catch (e) {console.log(e)}

		try {
			var func3_var6 = await self.cookieStore.dispatchEvent(event);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-3863_page-2.html#4009aa59');
		} catch (e) {console.log(e)}

		try {
			var func3_var8 = 'equals';
		} catch (e) {console.log(e)}

		try {
			var func3_var7 = {url: func3_var0, matchType: func3_var8, };
		} catch (e) {console.log(e)}

		try {
			var func3_var9 = await self.cookieStore.getAll(func3_var7);
		} catch (e) {console.log(e)}

		try {
			var func3_var10 = await event.preventDefault();
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.1:8080/input-3863_page-1.html#60d6a880');
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-bd85ceda] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-4e9b6bf6] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
