...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '15e351d3');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.1:8080/input-3860_page-2.html#17272fbf');
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var1 = await self.cookieStore.addEventListener(func0_var0,null,'');
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '493dce22');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.2:8080/input-3860_page-2.html#fee79cf2');
		} catch (e) {console.log(e)}
...
async function func1_func1(event) {
			try {
				check_site_violation('http://127.0.0.1:8080', location.origin, '888aec57');

			} catch (e) {console.log(e)}

			try {
				var func1_func1_var0 = 'http://127.0.0.1:8080/input-3860_page-2.html#870efcac';
			} catch (e) {console.log(e)}

			try {
				var func1_func1_var1 = await self.cookieStore.getAll(func1_func1_var0);
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_storage_key('http://127.0.0.2:8080/input-3860_page-1.html#666c4b13');
			} catch (e) {console.log(e)}

			try {
				var func1_func1_var2 = 'b061';
			} catch (e) {console.log(e)}

			try {
				var func1_func1_var3 = await self.clients.get(func1_func1_var2);
			} catch (e) {console.log(e)}

			try {
				var func1_func1_var5 = false;
			} catch (e) {console.log(e)}

			try {
				var func1_func1_var4 = {includeUncontrolled: func1_func1_var5, };
			} catch (e) {console.log(e)}

			try {
				var func1_func1_var6 = await self.clients.matchAll(func1_func1_var4);
			} catch (e) {console.log(e)}

			try {
				var func1_func1_var7 = 'foo';
			} catch (e) {console.log(e)}

			try {
				var func1_func1_var8 = await self.cookieStore.get(func1_func1_var7);
			} catch (e) {console.log(e)}

			try {
				var func1_func1_var9 = undefined;
			} catch (e) {console.log(e)}

			return func1_func1_var9;
		}

		try {
			self.onbackgroundfetched = func1_func1;
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.2:8080/input-3860_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.1:8080/input-3860_page-2.html#ee32d08c');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-3860_page-1.html#bf0ef03d');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.2:8080/input-3860_page-2.html#e60fdab8');
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'a23243a1');

		} catch (e) {console.log(e)}

		try {
			var func2_var0 = 'http://127.0.0.2:8080/input-3860_page-1.html#a56ebfc6';
		} catch (e) {console.log(e)}
		...
		try {
			var func2_var2 = 'http://127.0.0.1:8080/input-3860_page-1.html#ffb7db95';
		} catch (e) {console.log(e)}

		try {
			var func2_var3 = await func2_var1.navigate(func2_var2);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.1:8080/input-3860_page-2.html#e2e4aaf6');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.1:8080/input-3860_page-2.html#a56e651f');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-3860_page-2.html');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_url('http://127.0.0.1:8080/input-3860_page-1.html#040b93a3');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.1:8080/input-3860_page-1.html#b8f5e41b');
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '54d23f47');
		...
		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.1:8080/input-3860_page-2.html');
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var13 = await event.initEvent(func3_var11,func3_var12);
		} catch (e) {console.log(e)}

		try {
			var func3_var14 = await event.waitUntil(func3_var10);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-3860_page-1.html#23e3aaec');
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var15 = await self.clients.claim();
		} catch (e) {console.log(e)}

		try {
			var func3_var16 = undefined;
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-57d39dc0] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-28894042] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'aa18e284');
		...
		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.1:8080/input-3860_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-3860_page-1.html#bf32d7ad');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-3860_page-1.html#a2ed2d73');
		} catch (e) {console.log(e)}

		try {
			var func4_var2 = 'sharedworker';
		} catch (e) {console.log(e)}

		try {
			var func4_var1 = {type: func4_var2, };
		} catch (e) {console.log(e)}

		try {
			var func4_var3 = await self.clients.matchAll(func4_var1);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-3860_page-1.html#36cbd343');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.2:8080/input-3860_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-3860_page-2.html#63f19eec');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.2:8080/input-3860_page-1.html#249ec46e');
		} catch (e) {console.log(e)}
