...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '828827c2');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.2:8080/input-37_page-1.html#854e8ce3');
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'b6515dc8');

		} catch (e) {console.log(e)}

async function func1_func0(event) {
			try {
				check_site_violation('http://127.0.0.1:8080', location.origin, '72e40d03');
			...
			try {
				IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-37_page-1.html#42fdea46');
			} catch (e) {console.log(e)}
		...
		try {
			var func1_var2 = await self.clients.get(func1_var1);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.1:8080/input-37_page-1.html');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-37_page-2.html#0ee2df57');
		} catch (e) {console.log(e)}
...
async function func2(event) {
		...
		try {
			IPCFuzzer.mutate_url('http://127.0.0.1:8080/input-37_page-1.html#92de0e9e');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.2:8080/input-37_page-2.html');
		} catch (e) {console.log(e)}

		try {
			var func2_var2 = await self.clients.matchAll();
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '95a6a737');
		...
		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.2:8080/input-37_page-2.html');
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-2e4343d1] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-daeba85b] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'bef4ad62');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.2:8080/input-37_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-37_page-1.html#bff4369d');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.2:8080/input-37_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.2:8080/input-37_page-2.html');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.2:8080/input-37_page-2.html#ea5128ca');
		} catch (e) {console.log(e)}
