...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'c805da37');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.2:8080/input-6231_page-1.html');
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.2:8080/input-6231_page-1.html#f0beb18c');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.1:8080/input-6231_page-1.html');
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '37ac846b');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-6231_page-1.html#0ba0e056');
		} catch (e) {console.log(e)}

		try {
			var func2_var0 = 'http://127.0.0.1:8080/input-6231_page-1.html#ffcef5cc';
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '02d024c2');

		} catch (e) {console.log(e)}

		try {
			var func3_var0 = 'http://127.0.0.2:8080/input-6231_page-2.html#bacdfa0e';
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.1:8080/input-6231_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.2:8080/input-6231_page-2.html#acc3b2fc');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.2:8080/input-6231_page-1.html');
		} catch (e) {console.log(e)}

		try {
			var func3_var6 = await self.clients.claim();
		} catch (e) {console.log(e)}

		try {
			var func3_var8 = 'starts-with';
		} catch (e) {console.log(e)}

		try {
			var func3_var7 = {name: func3_var0, url: func3_var0, matchType: func3_var8, };
		} catch (e) {console.log(e)}

		try {
			var func3_var9 = await self.cookieStore.get(func3_var7);
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.1:8080/input-6231_page-1.html');
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-ad0ef550] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-98b81d66] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '2eda308e');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.1:8080/input-6231_page-2.html#d6e2860d');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-6231_page-2.html#a7af26ce');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.2:8080/input-6231_page-2.html');
		} catch (e) {console.log(e)}

		try {
			var func4_var5 = 'http://127.0.0.2:8080/input-6231_page-1.html#6fe98ccb';
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var9 = await func4_var4.postMessage(event,func4_var8);
		} catch (e) {console.log(e)}
