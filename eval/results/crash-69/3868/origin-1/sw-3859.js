...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'db12bc03');

		} catch (e) {console.log(e)}

		try {
			var func0_var0 = 'http://127.0.0.2:8080/input-3859_page-1.html#d3f7910d';
		} catch (e) {console.log(e)}

async function func0_func0(event) {
			try {
				check_site_violation('http://127.0.0.1:8080', location.origin, '4e040f8e');

			} catch (e) {console.log(e)}

			try {
				var func0_func0_var0 = 'http://127.0.0.2:8080/input-3859_page-2.html#36a2b15b';
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var1 = await self.cookieStore.getAll(func0_func0_var0);
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_url('http://127.0.0.1:8080/input-3859_page-1.html#59340daf');
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var2 = await event.preventDefault();
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.2:8080/input-3859_page-2.html');
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var3 = 'http://127.0.0.1:8080/input-3859_page-2.html#96147158';
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var4 = await self.cookieStore.delete(func0_func0_var3);
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_url_replace_host('http://127.0.0.2:8080/input-3859_page-2.html');
			} catch (e) {console.log(e)}
		...
		try {
			var func0_var7 = 'strict';
		} catch (e) {console.log(e)}

		try {
			var func0_var5 = {expires: Infinity, domain: func0_var0, path: func0_var0, secure: func0_var6, httpOnly: func0_var6, sameSite: func0_var7, };
		} catch (e) {console.log(e)}

		try {
			var func0_var8 = await self.cookieStore.set(func0_var3,func0_var4,func0_var5);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.2:8080/input-3859_page-1.html');
		} catch (e) {console.log(e)}

		try {
			var func0_var9 = await event.waitUntil(func0_var8);
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '7dc0cf89');
		...
		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-3859_page-1.html#66828d80');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-3859_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.2:8080/input-3859_page-2.html#c0eadfd7');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-3859_page-1.html#9d769974');
		} catch (e) {console.log(e)}

		try {
			var func1_var2 = 'http://127.0.0.2:8080/input-3859_page-1.html#5f497933';
		} catch (e) {console.log(e)}

		try {
			var func1_var3 = await self.cookieStore.delete(func1_var2);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.1:8080/input-3859_page-2.html');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-3859_page-1.html#e783708d');
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '7634edc6');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.2:8080/input-3859_page-2.html#3aa957b7');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-3859_page-1.html#fd378ea3');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.2:8080/input-3859_page-1.html#a8829db9');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.1:8080/input-3859_page-2.html');
		} catch (e) {console.log(e)}
		...
		try {
			var func2_var4 = await event.initEvent(func2_var1,func2_var2,func2_var3);
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'daccab05');

		} catch (e) {console.log(e)}

		try {
			var func3_var0 = 'http://127.0.0.1:8080/input-3859_page-1.html#77bba836';
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var2 = {expires: Infinity, domain: func3_var0, path: func3_var0, secure: func3_var3, httpOnly: func3_var3, sameSite: func3_var4, };
		} catch (e) {console.log(e)}

		try {
			var func3_var5 = await self.cookieStore.set(func3_var0,func3_var1,func3_var2);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-3859_page-2.html#0e49ea7e');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.1:8080/input-3859_page-1.html');
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var7 = await func3_var6.blob();
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.1:8080/input-3859_page-2.html');
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var10 = 'audio/mpeg';
		} catch (e) {console.log(e)}

		try {
			var func3_var11 = await func3_var7.slice(func3_var8,func3_var9,func3_var10);
		} catch (e) {console.log(e)}

		try {
			var func3_var12 = await func3_var11.slice();
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-3859_page-2.html#b84f6ae0');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.1:8080/input-3859_page-2.html#2f5a71f9');
		} catch (e) {console.log(e)}

		try {
			var func3_var13 = {name: func3_var0, url: func3_var0, };
		} catch (e) {console.log(e)}

		try {
			var func3_var14 = await self.cookieStore.getAll(func3_var13);
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var17 = 'text/plain';
		} catch (e) {console.log(e)}

		try {
			var func3_var18 = await func3_var7.slice(func3_var15,func3_var16,func3_var17);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.2:8080/input-3859_page-2.html');
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-421b1f6f] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-9bd0400c] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '73b307d6');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-3859_page-2.html#00b0d5d1');
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var2 = await event.stopPropagation();
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_url('http://127.0.0.1:8080/input-3859_page-2.html#0726cf23');
		} catch (e) {console.log(e)}
