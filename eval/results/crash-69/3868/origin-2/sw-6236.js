...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'bf17be9c');
		...
		try {
			var func0_var5 = await self.skipWaiting();
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var6 = {name: func0_var1, matchType: func0_var7, };
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'd05e6192');

		} catch (e) {console.log(e)}

		try {
			var func1_var0 = {name: self.origin, value: self.origin, };
		} catch (e) {console.log(e)}

		try {
			var func1_var1 = await self.cookieStore.set(func1_var0);
		} catch (e) {console.log(e)}
...
async function func1_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, '92469645');
...
async function func1_func0_func0(event) {
				try {
					check_site_violation('http://127.0.0.2:8080', location.origin, '31182289');

				} catch (e) {console.log(e)}

				try {
					var func1_func0_func0_var0 = 'http://127.0.0.2:8080/input-41_page-1.html#9072e202';
				} catch (e) {console.log(e)}

				try {
					var func1_func0_func0_var1 = await self.clients.openWindow(func1_func0_func0_var0);
				} catch (e) {console.log(e)}

				try {
					var func1_func0_func0_var2 = new Array(event);
				} catch (e) {console.log(e)}

				try {
					var func1_func0_func0_var3 = await func1_func0_func0_var1.postMessage(event,func1_func0_func0_var2);
				} catch (e) {console.log(e)}

				try {
					var func1_func0_func0_var4 = undefined;
				} catch (e) {console.log(e)}

				return func1_func0_func0_var4;
			}
			...
			try {
				var func1_func0_var4 = 'origin';
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var5 = 'navigate';
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var6 = 'omit';
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var7 = 'force-cache';
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var8 = 'manual';
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var9 = false;
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var3 = {method: func1_func0_var0, headers: '', body: func1_func0_var0, referrer: func1_func0_var0, referrerPolicy: func1_func0_var4, mode: func1_func0_var5, credentials: func1_func0_var6, cache: func1_func0_var7, redirect: func1_func0_var8, integrity: func1_func0_var0, keepalive: func1_func0_var9, window: event, };
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var10 = await self.fetch(func1_func0_var0,func1_func0_var3);
			} catch (e) {console.log(e)}
			...
			try {
				var func1_func0_var12 = await self.cookieStore.get(func1_func0_var11);
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var13 = undefined;
			} catch (e) {console.log(e)}

			return func1_func0_var13;
		}

		try {
			var func1_var5 = {handleEvent: func1_func0};
		} catch (e) {console.log(e)}

		try {
			var func1_var6 = await self.cookieStore.addEventListener(func1_var4,func1_var5,'');
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '7e5a9fc0');
		...
		try {
			var func2_var4 = 'http://127.0.0.2:8080/input-41_page-1.html#96b2a9ac';
		} catch (e) {console.log(e)}

		try {
			var func2_var3 = await self.clients.openWindow(func2_var4);
		} catch (e) {console.log(e)}

		try {
			var func2_var5 = await func2_var3.postMessage(event);
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'ed21f4c0');
		...
		try {
			var func3_var2 = 'http://127.0.0.2:8080/input-41_page-2.html#df79b93a';
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var5 = await func3_var0.json();
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var7 = await func3_var0.json();
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-5492490b] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-c31df5e5] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'f3d678ee');

		} catch (e) {console.log(e)}

		try {
			var func4_var1 = 'worker';
		} catch (e) {console.log(e)}

		try {
			var func4_var0 = {type: func4_var1, };
		} catch (e) {console.log(e)}
...
async function func4_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, '05243d60');

			} catch (e) {console.log(e)}

			try {
				var func4_func0_var0 = await self.clients.claim();
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var1 = await self.clients.matchAll(func4_var0);
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var2 = undefined;
			} catch (e) {console.log(e)}

			return func4_func0_var2;
		}

		try {
			self.onnotificationclose = func4_func0;
		} catch (e) {console.log(e)}
		...
		try {
			event.respondWith(fetch('http://127.0.0.2:8080/input-41_page-2.html#5466ec6e').then((resp) => {if (resp.ok) {return resp;} else {return fetch(event.request);}}).catch((err) => {return fetch(event.request);}));
		} catch (e) {console.log(e)}
	}
	try {
		self.onfetch = func4;
