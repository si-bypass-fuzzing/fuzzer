...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'ad519d76');
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '65f148d4');
		...
		try {
			var func1_var3 = 'equals';
		} catch (e) {console.log(e)}

		try {
			var func1_var2 = {name: self.origin, url: self.origin, matchType: func1_var3, };
		} catch (e) {console.log(e)}
		...
		try {
			var func1_var5 = 'http://127.0.0.2:8080/input-3863_page-2.html#5fc41750';
		} catch (e) {console.log(e)}

		try {
			var func1_var6 = 'http://127.0.0.1:8080/input-3863_page-1.html#b0c4d6ba';
		} catch (e) {console.log(e)}
		...
		try {
			var func1_var7 = {expires: Infinity, domain: self.origin, path: self.origin, secure: func1_var8, httpOnly: func1_var8, sameSite: func1_var9, };
		} catch (e) {console.log(e)}

		try {
			var func1_var10 = await self.cookieStore.set(func1_var5,func1_var6,func1_var7);
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '89379ad7');
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '2505987f');

		} catch (e) {console.log(e)}

		try {
			var func3_var0 = 'http://127.0.0.2:8080/input-3863_page-2.html#62408aca';
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var8 = {includeUncontrolled: func3_var1, };
		} catch (e) {console.log(e)}

		try {
			var func3_var9 = await self.clients.matchAll(func3_var8);
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-643e7c26] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-2d2611f7] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '2676c102');
		...
		try {
			var func4_var3 = 'window';
		} catch (e) {console.log(e)}

		try {
			var func4_var2 = {type: func4_var3, };
		} catch (e) {console.log(e)}

		try {
			var func4_var4 = await self.clients.matchAll(func4_var2);
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var6 = {handleEvent: func4_func0};
		} catch (e) {console.log(e)}

		try {
			var func4_var7 = await self.cookieStore.addEventListener(func4_var5,func4_var6,'');
		} catch (e) {console.log(e)}

		try {
			var func4_var8 = await self.clients.claim();
		} catch (e) {console.log(e)}
		...
		try {
			event.respondWith(fetch('http://127.0.0.2:8080/input-3863_page-2.html#ddfa0a40').then((resp) => {if (resp.ok) {return resp;} else {return fetch(event.request);}}).catch((err) => {return fetch(event.request);}));
		} catch (e) {console.log(e)}
	}
	try {
		self.onfetch = func4;
