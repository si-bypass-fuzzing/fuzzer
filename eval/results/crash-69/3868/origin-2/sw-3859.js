...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'd116dd23');
		...
		try {
			var func0_var2 = 'http://127.0.0.1:8080/input-3859_page-1.html#b105c4d0';
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var4 = await event.waitUntil(func0_var1);
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '55d1d8be');
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'a137ae2d');
		...
		try {
			var func2_var4 = {name: self.origin, domain: self.origin, path: self.origin, secure: func2_var1, sameSite: func2_var5, };
		} catch (e) {console.log(e)}

		try {
			var func2_var6 = await self.cookieStore.delete(func2_var4);
		} catch (e) {console.log(e)}
		...
		try {
			var func2_var7 = await self.clients.matchAll(func2_var0);
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '150618aa');
		...
		try {
			var func3_var1 = 'http://127.0.0.1:8080/input-3859_page-1.html#b8736fa5';
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-cabcd187] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-5e5dc403] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '776173ef');

		} catch (e) {console.log(e)}

		try {
			var func4_var1 = 'sharedworker';
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var4 = 'http://127.0.0.1:8080/input-3859_page-1.html#f963cf64';
		} catch (e) {console.log(e)}

		try {
			var func4_var3 = await self.clients.openWindow(func4_var4);
		} catch (e) {console.log(e)}
