...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'd5a65a25');
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '354a2bba');
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'c437531f');
		...
		try {
			var func2_var1 = await event.stopPropagation();
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'd2162a42');
		...
		try {
			var func3_var1 = await self.clients.matchAll();
		} catch (e) {console.log(e)}

		try {
			var func3_var3 = 'http://127.0.0.2:8080/input-39_page-2.html#0c3f9bce';
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var5 = await func3_var2.postMessage(event,func3_var4);
		} catch (e) {console.log(e)}

		try {
			var func3_var7 = 'worker';
		} catch (e) {console.log(e)}

		try {
			var func3_var6 = {type: func3_var7, };
		} catch (e) {console.log(e)}

		try {
			var func3_var8 = await self.clients.matchAll(func3_var6);
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-2a804a82] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-cde8f84b] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '1836bde0');

		} catch (e) {console.log(e)}

		try {
			var func4_var0 = 'http://127.0.0.1:8080/input-39_page-1.html#335f6026';
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var6 = await func4_var1.focus();
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var15 = await event.initEvent(func4_var12,func4_var13,func4_var14);
		} catch (e) {console.log(e)}

		try {
			var func4_var16 = await self.clients.claim();
		} catch (e) {console.log(e)}
