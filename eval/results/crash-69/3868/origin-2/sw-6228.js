...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '65031117');
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'ff6b3f6a');
		...
		try {
			var func1_var3 = await self.setInterval(self.origin,func1_var2,event);
		} catch (e) {console.log(e)}

		try {
			var func1_var4 = 'http://127.0.0.1:8080/input-33_page-2.html#9b31d31a';
		} catch (e) {console.log(e)}

		try {
			var func1_var5 = await self.cookieStore.get(func1_var4);
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '4f215919');
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'd4a0a982');
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-43431dab] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-ffd2230d] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'a1a9989e');
...
async function func4_func0_func0(event) {
			...
			try {
				self.onbackgroundfetchabort = func4_func0_func0;
			} catch (e) {console.log(e)}
		...
		try {
			var func4_var5 = {handleEvent: func4_func0};
		} catch (e) {console.log(e)}

		try {
			var func4_var6 = await self.addEventListener(func4_var4,func4_var5,func4_var1);
		} catch (e) {console.log(e)}
		...
		try {
			event.returnValue = func4_var7;
		} catch (e) {console.log(e)}

		try {
			var func4_var8 = 'http://127.0.0.2:8080/input-33_page-2.html#770bbe5a';
		} catch (e) {console.log(e)}

		try {
			self.origin = func4_var8;
		} catch (e) {console.log(e)}
