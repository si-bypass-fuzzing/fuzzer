...
async function func0(event) {
		...
		try {
			var func0_var4 = 'strict';
		} catch (e) {console.log(e)}

		try {
			var func0_var2 = {expires: Infinity, domain: func0_var0, path: func0_var0, secure: func0_var3, sameSite: func0_var4, };
		} catch (e) {console.log(e)}

		try {
			var func0_var5 = await self.cookieStore.set(func0_var0,func0_var1,func0_var2);
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var8 = 'http://127.0.0.2:8080/input-35_page-1.html#c477ea94';
		} catch (e) {console.log(e)}

		try {
			var func0_var9 = await self.clients.openWindow(func0_var8);
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '4af1c05a');
...
async function func1_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, '800a5451');

			} catch (e) {console.log(e)}

async function func1_func0_func0(event) {
				try {
					check_site_violation('http://127.0.0.2:8080', location.origin, '342f49e7');

				} catch (e) {console.log(e)}

				try {
					var func1_func0_func0_var0 = await event.preventDefault();
				} catch (e) {console.log(e)}

				try {
					var func1_func0_func0_var1 = await event.waitUntil(func1_var0);
				} catch (e) {console.log(e)}

				try {
					var func1_func0_func0_var2 = await event.waitUntil(func1_var0);
				} catch (e) {console.log(e)}

				try {
					var func1_func0_func0_var3 = await event.composedPath();
				} catch (e) {console.log(e)}

				try {
					var func1_func0_func0_var5 = false;
				} catch (e) {console.log(e)}

				try {
					var func1_func0_func0_var6 = 'window';
				} catch (e) {console.log(e)}

				try {
					var func1_func0_func0_var4 = {includeUncontrolled: func1_func0_func0_var5, type: func1_func0_func0_var6, };
				} catch (e) {console.log(e)}

				try {
					var func1_func0_func0_var7 = await self.clients.matchAll(func1_func0_func0_var4);
				} catch (e) {console.log(e)}

				try {
					var func1_func0_func0_var8 = false;
				} catch (e) {console.log(e)}

				try {
					event.returnValue = func1_func0_func0_var8;
				} catch (e) {console.log(e)}

				try {
					var func1_func0_func0_var9 = 'ed2d';
				} catch (e) {console.log(e)}

				try {
					var func1_func0_func0_var10 = await self.clients.get(func1_func0_func0_var9);
				} catch (e) {console.log(e)}
			...
			try {
				var func1_func0_var4 = await event.initEvent(func1_func0_var1,func1_func0_var2,func1_func0_var3);
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var5 = {name: func1_func0_var1, value: func1_func0_var1, };
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var6 = await self.cookieStore.set(func1_func0_var5);
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var7 = await self.cookieStore.get();
			} catch (e) {console.log(e)}
		...
		try {
			self.onbackgroundfetchclick = func1_func0;
		} catch (e) {console.log(e)}

		try {
			var func1_var1 = 'http://127.0.0.1:8080/input-35_page-2.html#0786d35b';
		} catch (e) {console.log(e)}

		try {
			var func1_var2 = false;
		} catch (e) {console.log(e)}
		...
		try {
			var func1_var4 = await event.initEvent(func1_var1,func1_var2,func1_var3);
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'ae77e61a');
		...
		try {
			var func2_var2 = await self.cookieStore.getChangeSubscriptions();
		} catch (e) {console.log(e)}

		try {
			var func2_var3 = 'http://127.0.0.1:8080/input-35_page-2.html#6f640149';
		} catch (e) {console.log(e)}
		...
		try {
			var func2_var7 = 'http://127.0.0.2:8080/input-35_page-2.html#d712d22a';
		} catch (e) {console.log(e)}

		try {
			var func2_var8 = await self.cookieStore.removeEventListener(func2_var7,null);
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '2be8ce1b');

		} catch (e) {console.log(e)}

		try {
			var func3_var1 = 'equals';
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var3 = await self.cookieStore.getAll();
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var8 = 'worker';
		} catch (e) {console.log(e)}

		try {
			var func3_var6 = {includeUncontrolled: func3_var7, type: func3_var8, };
		} catch (e) {console.log(e)}

		try {
			var func3_var9 = await self.clients.matchAll(func3_var6);
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-5e42df64] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-8154b961] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'a54634cb');

		} catch (e) {console.log(e)}

async function func4_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, 'ae528ea2');
			...
			try {
				var func4_func0_var1 = new Promise(eval);
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var2 = await event.waitUntil(func4_func0_var1);
			} catch (e) {console.log(e)}
		...
		try {
			self.onbackgroundfetchclick = func4_func0;
		} catch (e) {console.log(e)}
