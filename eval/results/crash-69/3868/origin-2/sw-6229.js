...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '6f83efc7');
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '1e424c26');
...
async function func3(event) {
		...
		try {
			var func3_var2 = 'http://127.0.0.1:8080/input-34_page-1.html#3a59b42d';
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var4 = {name: func3_var0, value: func3_var0, };
		} catch (e) {console.log(e)}

		try {
			var func3_var5 = await self.cookieStore.set(func3_var4);
		} catch (e) {console.log(e)}

		try {
			var func3_var6 = 'http://127.0.0.1:8080/input-34_page-2.html#6ebe8e1f';
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var8 = 'http://127.0.0.2:8080/input-34_page-2.html#5c1fa848';
		} catch (e) {console.log(e)}

		try {
			var func3_var9 = await func3_var1.navigate(func3_var8);
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-f7395f66] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-cda0d35c] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '114595b7');
