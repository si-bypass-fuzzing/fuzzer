...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'db67a336');
		...
		try {
			var func0_var5 = {name: self.origin, value: self.origin, };
		} catch (e) {console.log(e)}

		try {
			var func0_var6 = await self.cookieStore.set(func0_var5);
		} catch (e) {console.log(e)}

		try {
			var func0_var7 = 'http://127.0.0.1:8080/input-36_page-1.html#96a6e59a';
		} catch (e) {console.log(e)}

		try {
			var func0_var8 = await self.clients.openWindow(func0_var7);
		} catch (e) {console.log(e)}

		try {
			var func0_var9 = await event.preventDefault();
		} catch (e) {console.log(e)}

		try {
			var func0_var10 = await self.cookieStore.set(func0_var5);
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '1539c6b6');
		...
		try {
			var func1_var4 = await self.clients.get(func1_var3);
		} catch (e) {console.log(e)}

		try {
			var func1_var6 = 'http://127.0.0.2:8080/input-36_page-1.html#1853083a';
		} catch (e) {console.log(e)}

		try {
			var func1_var5 = await self.clients.openWindow(func1_var6);
		} catch (e) {console.log(e)}

		try {
			var func1_var7 = await func1_var5.focus();
		} catch (e) {console.log(e)}

		try {
			var func1_var8 = await self.cookieStore.dispatchEvent(event);
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'd620a152');
		...
		try {
			var func2_var3 = 'http://127.0.0.2:8080/input-36_page-1.html#7d4d380f';
		} catch (e) {console.log(e)}
		...
		try {
			var func2_var5 = new Array(event);
		} catch (e) {console.log(e)}

		try {
			var func2_var6 = await event.initMessageEvent(func2_var0,func2_var1,func2_var2,event,func2_var3,func2_var4,null,func2_var5);
		} catch (e) {console.log(e)}

		try {
			var func2_var7 = await event.preventDefault();
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '57c4e9e8');
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-fcd7559a] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-ee45335d] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '9dea3782');
