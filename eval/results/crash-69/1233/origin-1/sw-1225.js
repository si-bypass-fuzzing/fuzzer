...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '88ddf6b8');

		} catch (e) {console.log(e)}

async function func0_func0(event) {
			try {
				check_site_violation('http://127.0.0.1:8080', location.origin, '57bcf4f5');
			...
			try {
				IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.1:8080/input-1225_page-2.html');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-1225_page-1.html#d9646b93');
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var1 = await event.composedPath();
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var2 = 'foo';
			} catch (e) {console.log(e)}
			...
			try {
				var func0_func0_var5 = 'foo';
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var7 = true;
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var8 = 'strict';
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var6 = {expires: Infinity, domain: func0_func0_var2, path: func0_func0_var2, secure: func0_func0_var7, httpOnly: func0_func0_var7, sameSite: func0_func0_var8, };
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var9 = await self.cookieStore.set(func0_func0_var4,func0_func0_var5,func0_func0_var6);
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var10 = await event.stopPropagation();
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_origin_replace_host('http://127.0.0.2:8080/input-1225_page-1.html');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_storage_key('http://127.0.0.2:8080/input-1225_page-2.html#9aacbc83');
			} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.2:8080/input-1225_page-2.html#b3f6dede');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.1:8080/input-1225_page-1.html#76cff0f6');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.1:8080/input-1225_page-1.html#3ce464c5');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.2:8080/input-1225_page-1.html');
		} catch (e) {console.log(e)}

		try {
			var func0_var1 = await event.composedPath();
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-1225_page-2.html');
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var7 = await self.cookieStore.get(func0_var6);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.2:8080/input-1225_page-2.html#f8235153');
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '62cecb4f');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.1:8080/input-1225_page-2.html');
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '631b3294');
...
async function func2_func0(event) {
			try {
				check_site_violation('http://127.0.0.1:8080', location.origin, '2ec54814');

			} catch (e) {console.log(e)}

			try {
				var func2_func0_var0 = 'http://127.0.0.2:8080/input-1225_page-1.html#fb9099a3';
			} catch (e) {console.log(e)}

async function func2_func0_func0(event) {
				try {
					check_site_violation('http://127.0.0.1:8080', location.origin, '0f3883a9');

				} catch (e) {console.log(e)}

				try {
					IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-1225_page-1.html#52479829');
				} catch (e) {console.log(e)}

				try {
					IPCFuzzer.mutate_storage_key('http://127.0.0.2:8080/input-1225_page-1.html#44096d37');
				} catch (e) {console.log(e)}

				try {
					var func2_func0_func0_var0 = true;
				} catch (e) {console.log(e)}

				try {
					event.returnValue = func2_func0_func0_var0;
				} catch (e) {console.log(e)}

				try {
					IPCFuzzer.mutate_storage_key('http://127.0.0.1:8080/input-1225_page-2.html#04304e32');
				} catch (e) {console.log(e)}

				try {
					var func2_func0_func0_var1 = await event.preventDefault();
				} catch (e) {console.log(e)}

				try {
					IPCFuzzer.mutate_storage_key('http://127.0.0.1:8080/input-1225_page-2.html#994e9f36');
				} catch (e) {console.log(e)}

				try {
					var func2_func0_func0_var2 = undefined;
				} catch (e) {console.log(e)}

				return func2_func0_func0_var2;
			}
			...
			try {
				var func2_func0_var2 = await self.cookieStore.addEventListener(func2_func0_var0,func2_func0_var1,'');
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var3 = await self.clients.claim();
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_storage_key('http://127.0.0.2:8080/input-1225_page-2.html#dcff6917');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-1225_page-1.html#aacaff61');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_origin_replace_host('http://127.0.0.1:8080/input-1225_page-2.html');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-1225_page-1.html#07439e04');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-1225_page-1.html#a8d54d6a');
			} catch (e) {console.log(e)}
		...
		try {
			var func2_var2 = await self.cookieStore.addEventListener(func2_var0,func2_var1,'');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.1:8080/input-1225_page-2.html#e8f2eb5d');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-1225_page-1.html#26b07fdb');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-1225_page-2.html#88dc36ee');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.2:8080/input-1225_page-1.html#cf14b7d7');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.2:8080/input-1225_page-2.html#62a1bede');
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'f58eecd1');
...
async function func3_func0_func0(event) {
			...
			try {
				var func3_func0_var1 = await func3_func0_var0.json();
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-1225_page-1.html');
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var2 = await event.stopPropagation();
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var3 = await func3_func0_var0.arrayBuffer();
			} catch (e) {console.log(e)}
			...
			try {
				var func3_func0_var4 = await func3_func0_var0.json();
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-1225_page-1.html#62f48fba');
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var5 = 'c5d6';
			} catch (e) {console.log(e)}
			...
			try {
				var func3_func0_var7 = undefined;
			} catch (e) {console.log(e)}

			return func3_func0_var7;
		}

		try {
			self.onbackgroundfetchabort = func3_func0;
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var4 = await event.initEvent(func3_var1,func3_var2,func3_var3);
		} catch (e) {console.log(e)}

		try {
			self.onrejectionhandled = eval;
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_url('http://127.0.0.1:8080/input-1225_page-1.html#cc1229c9');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.2:8080/input-1225_page-2.html');
		} catch (e) {console.log(e)}

		try {
			var func3_var5 = 'http://127.0.0.1:8080/input-1225_page-1.html#780bfc95';
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var8 = 'http://127.0.0.1:8080/input-1225_page-2.html#a41ccab0';
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var10 = true;
		} catch (e) {console.log(e)}

		try {
			var func3_var11 = await event.initEvent(func3_var8,func3_var9,func3_var10);
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-0b990828] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-64db435b] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '00c3c66f');

		} catch (e) {console.log(e)}

		try {
			var func4_var0 = 'http://127.0.0.1:8080/input-1225_page-2.html#5ed61dcf';
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var2 = await event.composedPath();
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.1:8080/input-1225_page-1.html#959d29e3');
		} catch (e) {console.log(e)}
		...
		try {
			event.respondWith(fetch('http://127.0.0.2:8080/input-1225_page-1.html#54f1262a').then((resp) => {if (resp.ok) {return resp;} else {return fetch(event.request);}}).catch((err) => {return fetch(event.request);}));
		} catch (e) {console.log(e)}
	}
	try {
		self.onfetch = func4;
