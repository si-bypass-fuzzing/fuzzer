...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'c01a9052');
		...
		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.2:8080/input-1228_page-2.html');
		} catch (e) {console.log(e)}
...
async function func0_func0(event) {
			try {
				check_site_violation('http://127.0.0.1:8080', location.origin, 'ad967a9e');
			...
			try {
				IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-1228_page-1.html#bc030129');
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var2 = 'a97e';
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var3 = await self.clients.get(func0_func0_var2);
			} catch (e) {console.log(e)}
			...
			try {
				var func0_func0_var7 = await event.initEvent(func0_func0_var5,func0_func0_var6);
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var8 = await self.cookieStore.subscribeToChanges(func0_func0_var1);
			} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.1:8080/input-1228_page-2.html');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.1:8080/input-1228_page-1.html');
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var5 = {includeUncontrolled: func0_var6, type: func0_var7, };
		} catch (e) {console.log(e)}

		try {
			var func0_var8 = await self.clients.matchAll(func0_var5);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.2:8080/input-1228_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-1228_page-1.html#d9533610');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.1:8080/input-1228_page-2.html');
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '9187f605');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.1:8080/input-1228_page-2.html#f5ade9ae');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.1:8080/input-1228_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.2:8080/input-1228_page-1.html#85e1c64d');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.2:8080/input-1228_page-1.html');
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '84b3f5d0');
		...
		try {
			var func2_var1 = await event.composedPath();
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.2:8080/input-1228_page-1.html#711b7529');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.2:8080/input-1228_page-2.html');
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '5b137568');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.1:8080/input-1228_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.2:8080/input-1228_page-1.html#38b99eac');
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var2 = await func3_var1.focus();
		} catch (e) {console.log(e)}

		try {
			var func3_var3 = {name: func3_var0, value: func3_var0, };
		} catch (e) {console.log(e)}

		try {
			var func3_var4 = await self.cookieStore.set(func3_var3);
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-1228_page-1.html#f39aeba7');
		} catch (e) {console.log(e)}

		try {
			var func3_var6 = await self.cookieStore.get();
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-82576b61] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-fa7438fa] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'a11b8381');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.1:8080/input-1228_page-2.html');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.2:8080/input-1228_page-2.html#c168b0ff');
		} catch (e) {console.log(e)}
