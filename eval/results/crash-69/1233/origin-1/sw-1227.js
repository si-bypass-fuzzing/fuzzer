...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '34aeb0e9');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.1:8080/input-1227_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.1:8080/input-1227_page-2.html#91f5fccf');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.1:8080/input-1227_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-1227_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.1:8080/input-1227_page-1.html#6aa8dda3');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-1227_page-2.html#950c4cca');
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.2:8080/input-1227_page-1.html');
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '64821020');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.2:8080/input-1227_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.2:8080/input-1227_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.1:8080/input-1227_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.1:8080/input-1227_page-2.html');
		} catch (e) {console.log(e)}

		try {
			var func2_var0 = 'http://127.0.0.1:8080/input-1227_page-1.html#d2027d55';
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'd8460144');
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-16da36ce] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-c03dd2cb] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '1e5fbb51');
		...
		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.1:8080/input-1227_page-2.html#5edc949a');
		} catch (e) {console.log(e)}

		try {
			var func4_var8 = 'http://127.0.0.2:8080/input-1227_page-2.html#1354d0f5';
		} catch (e) {console.log(e)}

		try {
			var func4_var9 = await self.clients.openWindow(func4_var8);
		} catch (e) {console.log(e)}

		try {
			var func4_var11 = 'equals';
		} catch (e) {console.log(e)}

		try {
			var func4_var10 = {name: func4_var4, url: func4_var4, matchType: func4_var11, };
		} catch (e) {console.log(e)}

		try {
			var func4_var12 = await self.cookieStore.get(func4_var10);
		} catch (e) {console.log(e)}
