...
async function func0(event) {
		...
		try {
			var func0_var7 = 'no-store';
		} catch (e) {console.log(e)}

		try {
			var func0_var8 = 'error';
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var3 = {headers: '', body: func0_var0, referrer: func0_var0, referrerPolicy: func0_var4, mode: func0_var5, credentials: func0_var6, cache: func0_var7, redirect: func0_var8, keepalive: func0_var9, window: event, };
		} catch (e) {console.log(e)}

		try {
			var func0_var10 = await self.fetch(func0_var0,func0_var3);
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '4cf15165');

		} catch (e) {console.log(e)}

		try {
			var func1_var0 = 'http://127.0.0.1:8080/input-1228_page-2.html#63837211';
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '23605b85');
		...
		try {
			var func2_var0 = {includeUncontrolled: func2_var1, };
		} catch (e) {console.log(e)}
		...
		try {
			var func2_var3 = 'http://127.0.0.1:8080/input-1228_page-1.html#0637849a';
		} catch (e) {console.log(e)}
		...
		try {
			var func2_var5 = await self.cookieStore.getChangeSubscriptions();
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'aa26a301');
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-b3e4cdd9] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-cf44a112] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '497c2ada');
