...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'ee1bafab');
		...
		try {
			var func0_var4 = 'sharedworker';
		} catch (e) {console.log(e)}

		try {
			var func0_var2 = {includeUncontrolled: func0_var3, type: func0_var4, };
		} catch (e) {console.log(e)}

		try {
			var func0_var5 = await self.clients.matchAll(func0_var2);
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var7 = await self.atob(func0_var6);
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'b6841cb9');
		...
		try {
			var func1_var3 = 'http://127.0.0.2:8080/input-1223_page-1.html#576bb5eb';
		} catch (e) {console.log(e)}
		...
		try {
			var func1_var6 = await func1_var2.postMessage(event,func1_var5);
		} catch (e) {console.log(e)}

		try {
			var func1_var7 = 'http://127.0.0.2:8080/input-1223_page-1.html#ef8aa78d';
		} catch (e) {console.log(e)}

		try {
			var func1_var8 = await self.clients.openWindow(func1_var7);
		} catch (e) {console.log(e)}
		...
		try {
			var func1_var9 = {name: func1_var0, path: func1_var0, secure: func1_var10, sameSite: func1_var11, };
		} catch (e) {console.log(e)}

		try {
			var func1_var12 = await self.cookieStore.delete(func1_var9);
		} catch (e) {console.log(e)}

async function func1_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, '94728bfa');

			} catch (e) {console.log(e)}

			try {
				var func1_func0_var0 = 'http://127.0.0.1:8080/input-1223_page-2.html#0449cf1a';
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var1 = await func1_var2.navigate(func1_func0_var0);
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var2 = await event.waitUntil(func1_func0_var1);
			} catch (e) {console.log(e)}
			...
			try {
				var func1_func0_var4 = '6376';
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var5 = await self.clients.get(func1_func0_var4);
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var6 = await func1_var2.postMessage(event,func1_func0_var3);
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var7 = 'http://127.0.0.2:8080/input-1223_page-2.html#9182375c';
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var8 = await self.clients.openWindow(func1_func0_var7);
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var9 = await event.stopPropagation();
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var10 = await event.stopPropagation();
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var11 = await self.cookieStore.subscribeToChanges(func1_func0_var3);
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var12 = {name: func1_func0_var0, url: func1_func0_var0, };
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var13 = await self.cookieStore.getAll(func1_func0_var12);
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var14 = undefined;
			} catch (e) {console.log(e)}

			return func1_func0_var14;
		}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '09f73803');
...
async function func2_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, '81542f0f');

			} catch (e) {console.log(e)}

			try {
				var func2_func0_var0 = 'http://127.0.0.1:8080/input-1223_page-1.html#a76f7f45';
			} catch (e) {console.log(e)}
			...
			try {
				var func2_func0_var2 = 'http://127.0.0.2:8080/input-1223_page-1.html#5642dd5c';
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var3 = 'http://127.0.0.1:8080/input-1223_page-1.html#22b1a679';
			} catch (e) {console.log(e)}
		...
		try {
			var func2_var5 = 'strict';
		} catch (e) {console.log(e)}

		try {
			var func2_var3 = {name: func2_var0, domain: func2_var0, path: func2_var0, secure: func2_var4, sameSite: func2_var5, };
		} catch (e) {console.log(e)}

		try {
			var func2_var6 = await self.cookieStore.delete(func2_var3);
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '49bb80bd');

		} catch (e) {console.log(e)}

		try {
			var func3_var0 = 'http://127.0.0.2:8080/input-1223_page-1.html#dfc10157';
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var3 = await event.waitUntil(func3_var1);
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-f99c23a5] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-ead25ffe] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '775bef58');
		...
		try {
			var func4_var4 = 'http://127.0.0.2:8080/input-1223_page-1.html#f44c4774';
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var6 = 'http://127.0.0.1:8080/input-1223_page-2.html#9db67549';
		} catch (e) {console.log(e)}

		try {
			var func4_var7 = await self.clients.openWindow(func4_var6);
		} catch (e) {console.log(e)}
