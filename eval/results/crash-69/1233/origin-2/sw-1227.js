...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '54465527');
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '91847fab');
		...
		try {
			var func1_var8 = 'strict';
		} catch (e) {console.log(e)}

		try {
			var func1_var7 = {name: self.origin, domain: self.origin, path: self.origin, secure: func1_var3, sameSite: func1_var8, };
		} catch (e) {console.log(e)}

		try {
			var func1_var9 = await self.cookieStore.delete(func1_var7);
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '635c6cf4');
		...
		try {
			var func2_var4 = {name: self.origin, url: self.origin, matchType: func2_var5, };
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '32440e81');
		...
		try {
			var func3_var5 = 'http://127.0.0.2:8080/input-1227_page-2.html#0c7308af';
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-2c367058] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-da0e1a78] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '545045ae');
