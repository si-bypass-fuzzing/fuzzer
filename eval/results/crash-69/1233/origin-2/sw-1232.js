...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'a026455b');
		...
		try {
			var func0_var1 = 'http://127.0.0.1:8080/input-1232_page-2.html#7e289a5a';
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '643fbfdc');
		...
		try {
			var func1_var3 = {name: func1_var1, url: func1_var1, };
		} catch (e) {console.log(e)}

		try {
			var func1_var4 = await self.cookieStore.getAll(func1_var3);
		} catch (e) {console.log(e)}
		...
		try {
			var func1_var7 = 'window';
		} catch (e) {console.log(e)}

		try {
			var func1_var5 = {includeUncontrolled: func1_var6, type: func1_var7, };
		} catch (e) {console.log(e)}

		try {
			var func1_var8 = await self.clients.matchAll(func1_var5);
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '2bd41b32');
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'b3995ab8');

		} catch (e) {console.log(e)}

		try {
			var func3_var0 = 'http://127.0.0.1:8080/input-1232_page-2.html#4261ffc3';
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-d2cd038b] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-e50746c1] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '695de23a');

		} catch (e) {console.log(e)}

		try {
			var func4_var0 = await self.cookieStore.getChangeSubscriptions();
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var2 = await event.waitUntil(func4_var0);
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var7 = 'http://127.0.0.2:8080/input-1232_page-1.html#f7499d22';
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var8 = await func4_var6.focus();
		} catch (e) {console.log(e)}
		...
		try {
			event.respondWith(fetch('http://127.0.0.1:8080/input-1232_page-2.html#c33e1460').then((resp) => {if (resp.ok) {return resp;} else {return fetch(event.request);}}).catch((err) => {return fetch(event.request);}));
		} catch (e) {console.log(e)}
	}
	try {
		self.onfetch = func4;
