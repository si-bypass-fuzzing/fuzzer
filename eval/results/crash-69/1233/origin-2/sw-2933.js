...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'c7c8cc49');
		...
		try {
			var func0_var8 = await self.cookieStore.delete(func0_var1);
		} catch (e) {console.log(e)}

		try {
			var func0_var9 = 'http://127.0.0.1:8080/input-2933_page-2.html#0878bd03';
		} catch (e) {console.log(e)}

		try {
			var func0_var10 = await self.clients.openWindow(func0_var9);
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '107a5c50');
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '4c67bfca');
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'bb1fb060');
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-cdd375c4] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-a5131fb9] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '6f390d6f');
		...
		try {
			var func4_var3 = 'http://127.0.0.1:8080/input-2933_page-2.html#c6c09db5';
		} catch (e) {console.log(e)}

		try {
			var func4_var4 = await self.clients.openWindow(func4_var3);
		} catch (e) {console.log(e)}

		try {
			var func4_var5 = await event.composedPath();
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var8 = await event.waitUntil(func4_var1);
		} catch (e) {console.log(e)}
		...
		try {
			event.respondWith(fetch('http://127.0.0.1:8080/input-2933_page-2.html#b52c0ac9').then((resp) => {if (resp.ok) {return resp;} else {return fetch(event.request);}}).catch((err) => {return fetch(event.request);}));
		} catch (e) {console.log(e)}
	}
	try {
		self.onfetch = func4;
