...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '840eeb8c');
		...
		try {
			var func0_var7 = await event.preventDefault();
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'c85aaf23');

		} catch (e) {console.log(e)}

		try {
			var func1_var0 = await self.skipWaiting();
		} catch (e) {console.log(e)}

		try {
			var func1_var1 = 'http://127.0.0.2:8080/input-1233_page-1.html#72b43c23';
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '76debb16');
		...
		try {
			var func2_var1 = await self.setTimeout(self.origin,func2_var0,event);
		} catch (e) {console.log(e)}

		try {
			var func2_var2 = await event.preventDefault();
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '2f177e80');

		} catch (e) {console.log(e)}

		try {
			var func3_var0 = await self.fetch(self.origin);
		} catch (e) {console.log(e)}

		try {
			var func3_var1 = 'http://127.0.0.1:8080/input-1233_page-2.html#b492fa76';
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var5 = {name: self.origin, url: self.origin, };
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var7 = new Array(event);
		} catch (e) {console.log(e)}

		try {
			var func3_var8 = await func3_var4.postMessage(event,func3_var7);
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-1c5bef92] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-f26327e7] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'a9f9af06');
		...
		try {
			var func4_var1 = new Array(func4_var0);
		} catch (e) {console.log(e)}

		try {
			var func4_var2 = await self.cookieStore.subscribeToChanges(func4_var1);
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var3 = {type: func4_var4, };
		} catch (e) {console.log(e)}

		try {
			var func4_var5 = await self.clients.matchAll(func4_var3);
		} catch (e) {console.log(e)}

		try {
			var func4_var6 = await event.waitUntil(func4_var2);
		} catch (e) {console.log(e)}
