...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'dffdda90');
		...
		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.1:8080/input-7643_page-2.html');
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'b2cd35a7');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-7643_page-1.html#b1993200');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-7643_page-1.html#56d26cba');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.2:8080/input-7643_page-2.html#0a403d22');
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'f037d67c');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.2:8080/input-7643_page-1.html');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-7643_page-2.html#d8f61289');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.1:8080/input-7643_page-2.html#0e1aec01');
		} catch (e) {console.log(e)}

		try {
			var func2_var4 = 'http://127.0.0.1:8080/input-7643_page-1.html#92034172';
		} catch (e) {console.log(e)}
...
async function func3(event) {
		...
		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.1:8080/input-7643_page-2.html');
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var4 = await event.initEvent(func3_var3);
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var5 = {includeUncontrolled: func3_var6, };
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-0c9a30ad] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-a0b038b1] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'f8688361');
...
async function func4_func0(event) {
			try {
				check_site_violation('http://127.0.0.1:8080', location.origin, '32b8e9db');

			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_schemeful_site('http://127.0.0.1:8080/input-7643_page-1.html#44d0c1a6');
			} catch (e) {console.log(e)}
			...
			try {
				var func4_func0_var1 = 'b7bb';
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var2 = await self.clients.get(func4_func0_var1);
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_site_for_cookies('http://127.0.0.2:8080/input-7643_page-1.html#e54d8b70');
			} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-7643_page-2.html#be487fb9');
		} catch (e) {console.log(e)}

		try {
			var func4_var3 = 'http://127.0.0.2:8080/input-7643_page-2.html#7a60513d';
		} catch (e) {console.log(e)}

		try {
			var func4_var4 = await event.initEvent(func4_var3);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.2:8080/input-7643_page-1.html#e4439224');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.1:8080/input-7643_page-1.html');
		} catch (e) {console.log(e)}
