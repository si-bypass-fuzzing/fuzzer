...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '413b07cc');
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '0de24928');

		} catch (e) {console.log(e)}

async function func1_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, '04cfe580');

			} catch (e) {console.log(e)}

			try {
				var func1_func0_var0 = false;
			} catch (e) {console.log(e)}

			try {
				event.returnValue = func1_func0_var0;
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var2 = 'flipY';
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var3 = 'default';
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var4 = 'none';
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var5 = 'low';
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var1 = {imageOrientation: func1_func0_var2, premultiplyAlpha: func1_func0_var3, colorSpaceConversion: func1_func0_var4, resizeWidth: Infinity, resizeHeight: Infinity, resizeQuality: func1_func0_var5, };
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var6 = await self.createImageBitmap('',func1_func0_var1);
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var7 = await self.clients.claim();
			} catch (e) {console.log(e)}
		...
		try {
			var func1_var1 = 'worker';
		} catch (e) {console.log(e)}

		try {
			var func1_var0 = {type: func1_var1, };
		} catch (e) {console.log(e)}
		...
		try {
			var func1_var4 = await self.clients.claim();
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'f1aa61bb');

		} catch (e) {console.log(e)}

		try {
			var func2_var0 = 'http://127.0.0.1:8080/input-7640_page-2.html#0a0e48fc';
		} catch (e) {console.log(e)}
		...
		try {
			var func2_var3 = await event.initEvent(func2_var0,func2_var1,func2_var2);
		} catch (e) {console.log(e)}

		try {
			var func2_var4 = 'http://127.0.0.2:8080/input-7640_page-1.html#8999b509';
		} catch (e) {console.log(e)}

		try {
			var func2_var5 = await self.cookieStore.get(func2_var4);
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '8450dee8');
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-54a38d79] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-4a3adad9] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
...
async function func4_func1(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, '06211876');

			} catch (e) {console.log(e)}

			try {
				var func4_func1_var0 = await event.preventDefault();
			} catch (e) {console.log(e)}

			try {
				var func4_func1_var1 = await event.preventDefault();
			} catch (e) {console.log(e)}

			try {
				var func4_func1_var2 = 'http://127.0.0.2:8080/input-7640_page-2.html#8421b6b3';
			} catch (e) {console.log(e)}

			try {
				var func4_func1_var3 = await self.cookieStore.get(func4_func1_var2);
			} catch (e) {console.log(e)}

			try {
				var func4_func1_var4 = undefined;
			} catch (e) {console.log(e)}

			return func4_func1_var4;
		}

		try {
			self.onnotificationclose = func4_func1;
		} catch (e) {console.log(e)}
