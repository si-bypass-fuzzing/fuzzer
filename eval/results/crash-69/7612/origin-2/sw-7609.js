...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '69a1933f');
...
async function func0_func0(event) {
			...
			try {
				var func0_func0_var5 = await self.clients.claim();
			} catch (e) {console.log(e)}
			...
			try {
				var func0_func0_var8 = false;
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var9 = await event.initEvent(func0_func0_var6,func0_func0_var7,func0_func0_var8);
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var10 = -34;
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var11 = await self.setTimeout(func0_func0_var1,func0_func0_var10,event);
			} catch (e) {console.log(e)}
		...
		try {
			self.onbackgroundfetchclick = func0_func0;
		} catch (e) {console.log(e)}

		try {
			var func0_var1 = 'http://127.0.0.2:8080/input-7609_page-2.html#a1e559ae';
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var5 = new Promise(eval);
		} catch (e) {console.log(e)}

		try {
			var func0_var6 = await event.waitUntil(func0_var5);
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '2af44c90');
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'bbf7b927');
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '109a9d8b');
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-8a737660] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-f51ea0cf] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '6508bc5d');
