...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '25b45351');
...
async function func0_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, '0983f9b0');
			...
			try {
				var func0_func0_var1 = 'http://127.0.0.1:8080/input-7611_page-2.html#de8a13af';
			} catch (e) {console.log(e)}
			...
			try {
				var func0_func0_var3 = 'http://127.0.0.1:8080/input-7611_page-1.html#1388aa15';
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var4 = await func0_func0_var2.navigate(func0_func0_var3);
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var5 = await self.cookieStore.subscribeToChanges(func0_func0_var0);
			} catch (e) {console.log(e)}

async function func0_func0_func0(event) {
				try {
					check_site_violation('http://127.0.0.2:8080', location.origin, '913cf4a7');

				} catch (e) {console.log(e)}

				try {
					var func0_func0_func0_var0 = 'http://127.0.0.1:8080/input-7611_page-1.html#3c7ddf76';
				} catch (e) {console.log(e)}

				try {
					var func0_func0_func0_var1 = await self.cookieStore.get(func0_func0_func0_var0);
				} catch (e) {console.log(e)}

				try {
					var func0_func0_func0_var2 = false;
				} catch (e) {console.log(e)}

				try {
					event.returnValue = func0_func0_func0_var2;
				} catch (e) {console.log(e)}

				try {
					var func0_func0_func0_var3 = '8bf18cb9455f4a8e8fa93d14ab5ebb5d';
				} catch (e) {console.log(e)}

				try {
					var func0_func0_func0_var4 = false;
				} catch (e) {console.log(e)}

				try {
					var func0_func0_func0_var5 = true;
				} catch (e) {console.log(e)}

				try {
					var func0_func0_func0_var6 = await event.initEvent(func0_func0_func0_var3,func0_func0_func0_var4,func0_func0_func0_var5);
				} catch (e) {console.log(e)}

				try {
					var func0_func0_func0_var7 = 'http://127.0.0.2:8080/input-7611_page-1.html#d8452000';
				} catch (e) {console.log(e)}

				try {
					var func0_func0_func0_var8 = await self.cookieStore.getAll(func0_func0_func0_var7);
				} catch (e) {console.log(e)}

				try {
					var func0_func0_func0_var9 = await event.preventDefault();
				} catch (e) {console.log(e)}

				try {
					var func0_func0_func0_var10 = undefined;
				} catch (e) {console.log(e)}

				return func0_func0_func0_var10;
			}

			try {
				self.onpaymentrequest = func0_func0_func0;
			} catch (e) {console.log(e)}
		...
		try {
			var func0_var4 = await self.addEventListener(func0_var2,func0_var3,'');
		} catch (e) {console.log(e)}

		try {
			var func0_var5 = 'http://127.0.0.1:8080/input-7611_page-2.html#215dc4bf';
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '05078f05');
		...
		try {
			var func1_var1 = await self.clearInterval(func1_var0);
		} catch (e) {console.log(e)}

		try {
			var func1_var2 = 'http://127.0.0.2:8080/input-7611_page-2.html#20c6ca6b';
		} catch (e) {console.log(e)}

		try {
			var func1_var3 = await self.clients.openWindow(func1_var2);
		} catch (e) {console.log(e)}
		...
		try {
			var func1_var5 = new Array(func1_var4);
		} catch (e) {console.log(e)}

		try {
			var func1_var6 = await func1_var3.postMessage(event,func1_var5);
		} catch (e) {console.log(e)}
...
async function func1_func0(event) {
		...
		try {
			var func1_var12 = {handleEvent: func1_func0};
		} catch (e) {console.log(e)}

		try {
			var func1_var13 = await self.cookieStore.addEventListener(func1_var11,func1_var12,func1_var8);
		} catch (e) {console.log(e)}

		try {
			var func1_var14 = await self.clients.claim();
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'eaa05c60');
		...
		try {
			var func2_var4 = await self.cookieStore.getAll();
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '2c51cd58');
		...
		try {
			var func3_var6 = await event.waitUntil(func3_var5);
		} catch (e) {console.log(e)}

		try {
			var func3_var7 = await event.waitUntil(func3_var5);
		} catch (e) {console.log(e)}

		try {
			var func3_var9 = 'http://127.0.0.2:8080/input-7611_page-1.html#be844753';
		} catch (e) {console.log(e)}

		try {
			var func3_var8 = await self.clients.openWindow(func3_var9);
		} catch (e) {console.log(e)}

		try {
			var func3_var10 = 'http://127.0.0.2:8080/input-7611_page-2.html#6ca793b9';
		} catch (e) {console.log(e)}

		try {
			var func3_var11 = await func3_var8.navigate(func3_var10);
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-ad1ac6b7] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-c4f8cfac] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'a77e8895');
		...
		try {
			var func4_var1 = undefined;
		} catch (e) {console.log(e)}

		try {
			event.respondWith(fetch('http://127.0.0.1:8080/input-7611_page-1.html#57e383cb').then((resp) => {if (resp.ok) {return resp;} else {return fetch(event.request);}}).catch((err) => {return fetch(event.request);}));
		} catch (e) {console.log(e)}
	}
	try {
		self.onfetch = func4;
