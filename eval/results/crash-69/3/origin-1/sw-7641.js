...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '382d020e');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-7641_page-1.html#47e91b02');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-7641_page-2.html#568be92d');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.1:8080/input-7641_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.2:8080/input-7641_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.1:8080/input-7641_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-7641_page-2.html#a246f726');
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var3 = 'worker';
		} catch (e) {console.log(e)}

		try {
			var func0_var1 = {includeUncontrolled: func0_var2, type: func0_var3, };
		} catch (e) {console.log(e)}

		try {
			var func0_var4 = await self.clients.matchAll(func0_var1);
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '20b4af2d');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-7641_page-2.html#b81d6c7b');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-7641_page-1.html#1170b33e');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.2:8080/input-7641_page-2.html');
		} catch (e) {console.log(e)}
		...
		try {
			var func2_var4 = 'worker';
		} catch (e) {console.log(e)}

		try {
			var func2_var2 = {includeUncontrolled: func2_var3, type: func2_var4, };
		} catch (e) {console.log(e)}

		try {
			var func2_var5 = await self.clients.matchAll(func2_var2);
		} catch (e) {console.log(e)}

		try {
			var func2_var6 = await self.cookieStore.getChangeSubscriptions();
		} catch (e) {console.log(e)}

		try {
			var func2_var7 = 'http://127.0.0.1:8080/input-7641_page-1.html#147da2fa';
		} catch (e) {console.log(e)}

		try {
			var func2_var8 = await self.clients.openWindow(func2_var7);
		} catch (e) {console.log(e)}

		try {
			var func2_var9 = await event.stopImmediatePropagation();
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.2:8080/input-7641_page-1.html#268763a0');
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '991c8be5');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.1:8080/input-7641_page-2.html#f222963a');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.2:8080/input-7641_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.1:8080/input-7641_page-1.html');
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-75a3715b] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-03efe4bc] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '25216755');
