...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '2eed0b99');
...
async function func0_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, '55f3d695');

			} catch (e) {console.log(e)}

			try {
				var func0_func0_var0 = '8bf18cb9455f4a8e8fa93d14ab5ebb5d';
			} catch (e) {console.log(e)}
			...
			try {
				var func0_func0_var3 = true;
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var4 = 'unrestricted';
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var2 = {expires: Infinity, domain: func0_func0_var0, path: func0_func0_var0, secure: func0_func0_var3, httpOnly: func0_func0_var3, sameSite: func0_func0_var4, };
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var5 = await self.cookieStore.set(func0_func0_var0,func0_func0_var1,func0_func0_var2);
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var6 = 'http://127.0.0.2:8080/input-7643_page-1.html#1c306d89';
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var7 = await self.clients.openWindow(func0_func0_var6);
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var8 = await event.preventDefault();
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var9 = '8bf18cb9455f4a8e8fa93d14ab5ebb5d';
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var10 = await self.cookieStore.removeEventListener(func0_func0_var9,null,func0_func0_var3);
			} catch (e) {console.log(e)}
		...
		try {
			var func0_var5 = await self.cookieStore.removeEventListener(func0_var3,func0_var4,'');
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var7 = await self.clients.get(func0_var6);
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '98b97c91');
...
async function func1_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, 'cc191941');

			} catch (e) {console.log(e)}

			try {
				var func1_func0_var0 = '8bf18cb9455f4a8e8fa93d14ab5ebb5d';
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var1 = await self.cookieStore.get(func1_func0_var0);
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var2 = undefined;
			} catch (e) {console.log(e)}

			return func1_func0_var2;
		}
		...
		try {
			var func1_var4 = await self.removeEventListener(func1_var2,func1_var3,'');
		} catch (e) {console.log(e)}
...
async function func2_func0(event) {
			...
			try {
				var func2_func0_var4 = 'http://127.0.0.2:8080/input-7643_page-2.html#83a37133';
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var5 = await self.cookieStore.delete(func2_func0_var4);
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var6 = 16;
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var7 = new Array(func2_func0_var6);
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var8 = await func2_func0_var1.postMessage(event,func2_func0_var7);
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var9 = 'http://127.0.0.2:8080/input-7643_page-1.html#47830aef';
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var10 = await self.btoa(func2_func0_var9);
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var11 = await event.preventDefault();
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var12 = undefined;
			} catch (e) {console.log(e)}

			return func2_func0_var12;
		}
...
async function func2_func1(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, '6593d2a8');

			} catch (e) {console.log(e)}

			try {
				var func2_func1_var0 = await event.stopImmediatePropagation();
			} catch (e) {console.log(e)}

			try {
				var func2_func1_var1 = true;
			} catch (e) {console.log(e)}

			try {
				event.returnValue = func2_func1_var1;
			} catch (e) {console.log(e)}

			try {
				var func2_func1_var2 = await event.stopImmediatePropagation();
			} catch (e) {console.log(e)}

			try {
				var func2_func1_var3 = 'http://127.0.0.1:8080/input-7643_page-2.html#a7a5ccc0';
			} catch (e) {console.log(e)}

			try {
				var func2_func1_var4 = await self.cookieStore.delete(func2_func1_var3);
			} catch (e) {console.log(e)}

			try {
				var func2_func1_var5 = 'e80b';
			} catch (e) {console.log(e)}

			try {
				var func2_func1_var6 = await self.clients.get(func2_func1_var5);
			} catch (e) {console.log(e)}

			try {
				var func2_func1_var7 = undefined;
			} catch (e) {console.log(e)}

			return func2_func1_var7;
		}

		try {
			self.onpushsubscriptionchange = func2_func1;
		} catch (e) {console.log(e)}

		try {
			var func2_var3 = {name: func2_var0, value: func2_var0, };
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'e949ecda');

		} catch (e) {console.log(e)}

		try {
			var func3_var0 = await self.clients.matchAll();
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var2 = await self.clients.claim();
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var7 = await self.clients.get(func3_var6);
		} catch (e) {console.log(e)}

		try {
			var func3_var8 = await event.preventDefault();
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-9217280e] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-85cee95b] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'd716cd07');
		...
		try {
			var func4_var1 = 'http://127.0.0.1:8080/input-7643_page-2.html#6a9afce4';
		} catch (e) {console.log(e)}
		...
		try {
			event.respondWith(fetch('http://127.0.0.2:8080/input-7643_page-1.html#e2563914').then((resp) => {if (resp.ok) {return resp;} else {return fetch(event.request);}}).catch((err) => {return fetch(event.request);}));
		} catch (e) {console.log(e)}
	}
	try {
		self.onfetch = func4;
