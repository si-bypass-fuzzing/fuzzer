...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'e331fcd9');
		...
		try {
			var func0_var2 = 'http://127.0.0.1:8080/input-238_page-2.html#6455b47f';
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var6 = 'http://127.0.0.1:8080/input-238_page-2.html#f2eb1ae7';
		} catch (e) {console.log(e)}

		try {
			var func0_var7 = await self.cookieStore.addEventListener(func0_var6,null,func0_var5);
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var9 = await self.clients.get(func0_var8);
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '5d120695');

		} catch (e) {console.log(e)}

		try {
			var func1_var0 = 'http://127.0.0.1:8080/input-238_page-2.html#048c55a6';
		} catch (e) {console.log(e)}
		...
		try {
			var func1_var2 = await func1_var1.postMessage(event);
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '875958f3');
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '58af8aa5');
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-191a091c] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-6e536fb1] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'bf287970');
		...
		try {
			var func4_var3 = await func4_var1.focus();
		} catch (e) {console.log(e)}

		try {
			var func4_var4 = 'http://127.0.0.1:8080/input-238_page-1.html#b9c28ccc';
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var7 = await func4_var1.postMessage(event,func4_var6);
		} catch (e) {console.log(e)}
		...
		try {
			event.respondWith(fetch('http://127.0.0.1:8080/input-238_page-1.html#eeea83c8').then((resp) => {if (resp.ok) {return resp;} else {return fetch(event.request);}}).catch((err) => {return fetch(event.request);}));
		} catch (e) {console.log(e)}
	}
	try {
		self.onfetch = func4;
