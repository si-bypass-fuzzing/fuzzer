...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '6711b46e');
		...
		try {
			var func0_var3 = {name: func0_var1, value: func0_var1, };
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '84d4dae5');
		...
		try {
			var func1_var6 = 'worker';
		} catch (e) {console.log(e)}

		try {
			var func1_var4 = {includeUncontrolled: func1_var5, type: func1_var6, };
		} catch (e) {console.log(e)}

		try {
			var func1_var7 = await self.clients.matchAll(func1_var4);
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '255cbfc1');
		...
		try {
			var func2_var3 = await self.cookieStore.removeEventListener(func2_var2,null);
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '4b2da98e');
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-a808ca1d] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-664bff6d] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '2b38dfb3');
