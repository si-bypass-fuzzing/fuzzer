...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'fc70dc88');

		} catch (e) {console.log(e)}

		try {
			var func0_var0 = 'http://127.0.0.2:8080/input-692_page-1.html#c34b1119';
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var6 = await self.cookieStore.subscribeToChanges(func0_var5);
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'afbf6d9e');
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '80fbd3a0');
		...
		try {
			var func2_var2 = 'http://127.0.0.2:8080/input-692_page-2.html#5ffee4a8';
		} catch (e) {console.log(e)}
		...
		try {
			var func2_var7 = false;
		} catch (e) {console.log(e)}

		try {
			var func2_var8 = 'sharedworker';
		} catch (e) {console.log(e)}

		try {
			var func2_var6 = {includeUncontrolled: func2_var7, type: func2_var8, };
		} catch (e) {console.log(e)}

		try {
			var func2_var9 = await self.clients.matchAll(func2_var6);
		} catch (e) {console.log(e)}
...
async function func3_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, 'b1e02419');
			...
			try {
				var func3_func0_var2 = await event.preventDefault();
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var3 = '5492';
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var4 = await self.clients.get(func3_func0_var3);
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var5 = await self.cookieStore.dispatchEvent(event);
			} catch (e) {console.log(e)}
		...
		try {
			var func3_var6 = await self.cookieStore.addEventListener(func3_var4,func3_var5,func3_var2);
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var9 = await func3_var8.arrayBuffer();
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-aeb609cf] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-4592147d] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'a120588f');

		} catch (e) {console.log(e)}

		try {
			var func4_var0 = 'http://127.0.0.1:8080/input-692_page-1.html#bd37b748';
		} catch (e) {console.log(e)}
		...
		try {
			event.respondWith(fetch('http://127.0.0.1:8080/input-692_page-2.html#83f7dd57').then((resp) => {if (resp.ok) {return resp;} else {return fetch(event.request);}}).catch((err) => {return fetch(event.request);}));
		} catch (e) {console.log(e)}
	}
	try {
		self.onfetch = func4;
