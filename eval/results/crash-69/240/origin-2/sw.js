...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'a63c81b5');
		...
		try {
			var func0_var5 = 'http://127.0.0.1:8080/input-240_page-2.html#f5b1abe9';
		} catch (e) {console.log(e)}

		try {
			var func0_var6 = await self.cookieStore.getAll(func0_var5);
		} catch (e) {console.log(e)}

		try {
			var func0_var7 = await self.clients.matchAll(func0_var0);
		} catch (e) {console.log(e)}

		try {
			var func0_var8 = await self.clients.matchAll(func0_var0);
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '37d5112d');
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '182c67d8');
		...
		try {
			var func2_var1 = await event.preventDefault();
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '6f36bece');
...
async function func3_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, '7d7e0d66');

			} catch (e) {console.log(e)}

			try {
				var func3_func0_var0 = 'http://127.0.0.2:8080/input-240_page-2.html#be27d54d';
			} catch (e) {console.log(e)}
			...
			try {
				var func3_func0_var4 = 'lax';
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var2 = {domain: func3_func0_var0, path: func3_func0_var0, secure: func3_func0_var3, httpOnly: func3_func0_var3, sameSite: func3_func0_var4, };
			} catch (e) {console.log(e)}
			...
			try {
				var func3_func0_var11 = await event.initEvent(func3_func0_var8,func3_func0_var9,func3_func0_var10);
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var12 = await event.stopPropagation();
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var13 = undefined;
			} catch (e) {console.log(e)}

			return func3_func0_var13;
		}

		try {
			var func3_var2 = {handleEvent: func3_func0};
		} catch (e) {console.log(e)}

		try {
			var func3_var3 = await self.cookieStore.addEventListener(func3_var1,func3_var2,'');
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var5 = await self.clients.matchAll(func3_var4);
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-f2d3b9aa] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-0f083a5b] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '3a8d9fed');
