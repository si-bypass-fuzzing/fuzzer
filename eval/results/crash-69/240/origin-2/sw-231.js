...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'aed200d0');
		...
		try {
			var func0_var2 = 'http://127.0.0.1:8080/input-231_page-1.html#2458c82f';
		} catch (e) {console.log(e)}

		try {
			var func0_var3 = await self.clients.openWindow(func0_var2);
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'df0dce79');

		} catch (e) {console.log(e)}

		try {
			var func1_var0 = await self.clients.matchAll();
		} catch (e) {console.log(e)}

		try {
			var func1_var1 = '8bf18cb9455f4a8e8fa93d14ab5ebb5d';
		} catch (e) {console.log(e)}

		try {
			var func1_var2 = await self.cookieStore.getAll(func1_var1);
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '8c0d353c');
		...
		try {
			var func2_var4 = {includeUncontrolled: func2_var1, type: func2_var5, };
		} catch (e) {console.log(e)}

		try {
			var func2_var6 = await self.clients.matchAll(func2_var4);
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '2122daec');

		} catch (e) {console.log(e)}

async function func3_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, '7ea089a8');

			} catch (e) {console.log(e)}

			try {
				var func3_func0_var0 = 'http://127.0.0.2:8080/input-231_page-2.html#8e7f7e92';
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var1 = await self.cookieStore.getAll(func3_func0_var0);
			} catch (e) {console.log(e)}
...
async function func3_func0_func0(event) {
				try {
					check_site_violation('http://127.0.0.2:8080', location.origin, '54a383c2');
				...
				try {
					var func3_func0_func0_var1 = await event.respondWith(func3_func0_var1);
				} catch (e) {console.log(e)}

				try {
					var func3_func0_func0_var2 = 'http://127.0.0.1:8080/input-231_page-2.html#0ee386ba';
				} catch (e) {console.log(e)}
				...
				try {
					var func3_func0_func0_var4 = await event.initEvent(func3_func0_func0_var2,func3_func0_func0_var3);
				} catch (e) {console.log(e)}

				try {
					var func3_func0_func0_var6 = 'http://127.0.0.1:8080/input-231_page-2.html#8252b727';
				} catch (e) {console.log(e)}

				try {
					var func3_func0_func0_var5 = await event.openWindow(func3_func0_func0_var6);
				} catch (e) {console.log(e)}

				try {
					var func3_func0_func0_var7 = await func3_func0_func0_var5.focus();
				} catch (e) {console.log(e)}

				try {
					var func3_func0_func0_var8 = undefined;
				} catch (e) {console.log(e)}

				return func3_func0_func0_var8;
			}

			try {
				self.onpaymentrequest = func3_func0_func0;
			} catch (e) {console.log(e)}
			...
			try {
				var func3_func0_var4 = '8bf18cb9455f4a8e8fa93d14ab5ebb5d';
			} catch (e) {console.log(e)}

async function func3_func0_func1(event) {
				try {
					check_site_violation('http://127.0.0.2:8080', location.origin, '3c89aece');

				} catch (e) {console.log(e)}

				try {
					var func3_func0_func1_var0 = false;
				} catch (e) {console.log(e)}

				try {
					event.returnValue = func3_func0_func1_var0;
				} catch (e) {console.log(e)}

				try {
					var func3_func0_func1_var1 = '8bf18cb9455f4a8e8fa93d14ab5ebb5d';
				} catch (e) {console.log(e)}

				try {
					var func3_func0_func1_var2 = await self.cookieStore.get(func3_func0_func1_var1);
				} catch (e) {console.log(e)}

				try {
					var func3_func0_func1_var3 = '8bf18cb9455f4a8e8fa93d14ab5ebb5d';
				} catch (e) {console.log(e)}

				try {
					var func3_func0_func1_var4 = await self.cookieStore.addEventListener(func3_func0_func1_var3,null,func3_func0_func1_var0);
				} catch (e) {console.log(e)}

				try {
					var func3_func0_func1_var5 = undefined;
				} catch (e) {console.log(e)}

				return func3_func0_func1_var5;
			}

			try {
				var func3_func0_var5 = {handleEvent: func3_func0_func1};
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var6 = await self.cookieStore.addEventListener(func3_func0_var4,func3_func0_var5,'');
			} catch (e) {console.log(e)}
		...
		try {
			var func3_var0 = 'http://127.0.0.1:8080/input-231_page-2.html#a374dccb';
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var4 = new Promise(eval);
		} catch (e) {console.log(e)}

		try {
			var func3_var5 = await event.waitUntil(func3_var4);
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-89e8e039] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-6c901e23] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'd0791252');
		...
		try {
			var func4_var4 = 'http://127.0.0.2:8080/input-231_page-2.html#1e2550d2';
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var8 = await func4_var2.postMessage(event,func4_var7);
		} catch (e) {console.log(e)}

		try {
			var func4_var9 = await event.stopPropagation();
		} catch (e) {console.log(e)}

		try {
			var func4_var10 = await self.cookieStore.getChangeSubscriptions();
		} catch (e) {console.log(e)}

		try {
			var func4_var11 = await event.stopImmediatePropagation();
		} catch (e) {console.log(e)}
