...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '63529c70');

		} catch (e) {console.log(e)}

		try {
			var func0_var0 = 'http://127.0.0.2:8080/input-688_page-2.html#f8f068f4';
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '58278efb');
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'b49c0590');

		} catch (e) {console.log(e)}

		try {
			var func2_var0 = 'http://127.0.0.1:8080/input-688_page-2.html#e9bfb16f';
		} catch (e) {console.log(e)}
		...
		try {
			var func2_var4 = {name: func2_var0, domain: func2_var0, path: func2_var0, secure: func2_var5, sameSite: func2_var6, };
		} catch (e) {console.log(e)}

		try {
			var func2_var7 = await self.cookieStore.delete(func2_var4);
		} catch (e) {console.log(e)}
...
async function func2_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, '05c74a38');
			...
			try {
				var func2_func0_var1 = await self.cookieStore.delete(func2_func0_var0);
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var2 = 'http://127.0.0.1:8080/input-688_page-1.html#44fff85f';
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var3 = await func2_var1.navigate(func2_func0_var2);
			} catch (e) {console.log(e)}
		...
		try {
			var func2_var9 = {handleEvent: func2_func0};
		} catch (e) {console.log(e)}

		try {
			var func2_var10 = await self.cookieStore.removeEventListener(func2_var8,func2_var9,func2_var5);
		} catch (e) {console.log(e)}

		try {
			var func2_var11 = '2b08';
		} catch (e) {console.log(e)}

		try {
			var func2_var12 = await self.clients.get(func2_var11);
		} catch (e) {console.log(e)}

		try {
			var func2_var13 = await self.clients.claim();
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '669cecf6');
		...
		try {
			var func3_var2 = await self.cookieStore.getAll(func3_var0);
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-ff5b7d24] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-1ae76e08] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '0b2139de');
...
async function func4_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, '9a5f29dc');
			...
			try {
				var func4_func0_var1 = '8bf18cb9455f4a8e8fa93d14ab5ebb5d';
			} catch (e) {console.log(e)}
			...
			try {
				var func4_func0_var3 = await event.initEvent(func4_func0_var1,func4_func0_var2);
			} catch (e) {console.log(e)}
		...
		try {
			var func4_var3 = await self.cookieStore.removeEventListener(func4_var1,func4_var2,'');
		} catch (e) {console.log(e)}
