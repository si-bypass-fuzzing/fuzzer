...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'f6bd90f4');

		} catch (e) {console.log(e)}

		try {
			var func0_var0 = 'http://127.0.0.1:8080/input-236_page-1.html#0af94cd1';
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var4 = 'http://127.0.0.2:8080/input-236_page-2.html#56089655';
		} catch (e) {console.log(e)}

		try {
			var func0_var5 = await self.cookieStore.get(func0_var4);
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '6105a012');
		...
		try {
			var func1_var3 = 'http://127.0.0.2:8080/input-236_page-1.html#3bc53c3b';
		} catch (e) {console.log(e)}
		...
		try {
			var func1_var7 = await func1_var2.postMessage(event,func1_var5);
		} catch (e) {console.log(e)}

async function func1_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, '3be5dede');
			...
			try {
				var func1_func0_var1 = await self.cookieStore.getAll(func1_func0_var0);
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var2 = await func1_var2.focus();
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var3 = await func1_var2.postMessage(event,func1_var5);
			} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '598a3b75');
		...
		try {
			var func2_var2 = 'http://127.0.0.1:8080/input-236_page-1.html#a16ad3f9';
		} catch (e) {console.log(e)}
		...
		try {
			var func2_var3 = 'http://127.0.0.1:8080/input-236_page-1.html#39812bc2';
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '6d831bcd');
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-69c59a17] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-cad4d2b9] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'b1317a81');
...
async function func4_func0(event) {
			...
			try {
				var func4_func0_var4 = 'http://127.0.0.2:8080/input-236_page-1.html#0e174356';
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var3 = await self.clients.openWindow(func4_func0_var4);
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var5 = await func4_func0_var3.focus();
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var6 = await event.waitUntil(func4_func0_var2);
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var7 = await event.stopPropagation();
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var8 = await event.waitUntil(func4_func0_var2);
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var9 = await self.clients.claim();
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var10 = await func4_func0_var3.focus();
			} catch (e) {console.log(e)}
		...
		try {
			var func4_var6 = await self.cookieStore.addEventListener(func4_var4,func4_var5,'');
		} catch (e) {console.log(e)}
		...
		try {
			event.respondWith(fetch('http://127.0.0.2:8080/input-236_page-1.html#cdd370e3').then((resp) => {if (resp.ok) {return resp;} else {return fetch(event.request);}}).catch((err) => {return fetch(event.request);}));
		} catch (e) {console.log(e)}
	}
	try {
		self.onfetch = func4;
