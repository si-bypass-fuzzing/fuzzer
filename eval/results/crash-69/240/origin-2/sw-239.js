...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'c32219b9');

		} catch (e) {console.log(e)}

		try {
			var func0_var0 = 'http://127.0.0.2:8080/input-239_page-2.html#df10acdf';
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var8 = await event.initEvent(func0_var5,func0_var6,func0_var7);
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'aec4216f');
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '2bf64118');

		} catch (e) {console.log(e)}

		try {
			var func2_var0 = 'http://127.0.0.1:8080/input-239_page-1.html#e4d53be1';
		} catch (e) {console.log(e)}

async function func2_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, 'f717de59');
			...
			try {
				var func2_func0_var2 = await self.clients.claim();
			} catch (e) {console.log(e)}
			...
			try {
				var func2_func0_var5 = 'unrestricted';
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var3 = {name: self.origin, domain: self.origin, path: self.origin, secure: func2_func0_var4, sameSite: func2_func0_var5, };
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var6 = await self.cookieStore.delete(func2_func0_var3);
			} catch (e) {console.log(e)}

async function func2_func0_func0(event) {
				try {
					check_site_violation('http://127.0.0.2:8080', location.origin, '32907ab8');
				...
				try {
					var func2_func0_func0_var1 = new Array(event);
				} catch (e) {console.log(e)}

				try {
					var func2_func0_func0_var2 = await self.cookieStore.subscribeToChanges(func2_func0_func0_var1);
				} catch (e) {console.log(e)}

				try {
					var func2_func0_func0_var3 = 'http://127.0.0.2:8080/input-239_page-2.html#20e6fa9f';
				} catch (e) {console.log(e)}

				try {
					var func2_func0_func0_var4 = await self.cookieStore.getAll(func2_func0_func0_var3);
				} catch (e) {console.log(e)}
				...
				try {
					var func2_func0_func0_var6 = '8bf18cb9455f4a8e8fa93d14ab5ebb5d';
				} catch (e) {console.log(e)}

				try {
					var func2_func0_func0_var7 = await self.cookieStore.getAll(func2_func0_func0_var6);
				} catch (e) {console.log(e)}

				try {
					var func2_func0_func0_var8 = true;
				} catch (e) {console.log(e)}

				try {
					event.returnValue = func2_func0_func0_var8;
				} catch (e) {console.log(e)}

				try {
					var func2_func0_func0_var10 = 'all';
				} catch (e) {console.log(e)}

				try {
					var func2_func0_func0_var9 = {includeUncontrolled: func2_func0_func0_var0, type: func2_func0_func0_var10, };
				} catch (e) {console.log(e)}

				try {
					var func2_func0_func0_var11 = await self.clients.matchAll(func2_func0_func0_var9);
				} catch (e) {console.log(e)}

				try {
					var func2_func0_func0_var12 = await self.cookieStore.subscribeToChanges(func2_func0_func0_var1);
				} catch (e) {console.log(e)}

				try {
					var func2_func0_func0_var13 = undefined;
				} catch (e) {console.log(e)}

				return func2_func0_func0_var13;
			}

			try {
				self.onbackgroundfetchclick = func2_func0_func0;
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var7 = undefined;
			} catch (e) {console.log(e)}

			return func2_func0_var7;
		}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'c275fa8f');
		...
		try {
			var func3_var6 = 'http://127.0.0.2:8080/input-239_page-2.html#51dbfdf8';
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var8 = new Array(func3_var7);
		} catch (e) {console.log(e)}

		try {
			var func3_var9 = await func3_var5.postMessage(event,func3_var8);
		} catch (e) {console.log(e)}

		try {
			var func3_var10 = 'http://127.0.0.1:8080/input-239_page-1.html#2a74899f';
		} catch (e) {console.log(e)}

		try {
			var func3_var11 = await func3_var5.navigate(func3_var10);
		} catch (e) {console.log(e)}

		try {
			var func3_var12 = event.data;
		} catch (e) {console.log(e)}

		try {
			var func3_var13 = await func3_var12.text();
		} catch (e) {console.log(e)}

		try {
			var func3_var14 = await self.clients.claim();
		} catch (e) {console.log(e)}

		try {
			var func3_var15 = undefined;
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-25d8c1fc] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-652260bb] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'de7f6213');
		...
		try {
			var func4_var2 = await self.cookieStore.addEventListener(func4_var0,func4_var1,'');
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var4 = await self.cookieStore.delete(func4_var3);
		} catch (e) {console.log(e)}

async function func4_func1(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, 'd5fff0af');

			} catch (e) {console.log(e)}

			try {
				var func4_func1_var0 = false;
			} catch (e) {console.log(e)}

			try {
				event.returnValue = func4_func1_var0;
			} catch (e) {console.log(e)}

			try {
				var func4_func1_var1 = undefined;
			} catch (e) {console.log(e)}

			return func4_func1_var1;
		}

		try {
			self.oncookiechange = func4_func1;
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var6 = await self.cookieStore.getAll(func4_var5);
		} catch (e) {console.log(e)}
