...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '90af2eb7');
		...
		try {
			var func0_var3 = await event.stopImmediatePropagation();
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '1347cd6f');
		...
		try {
			var func1_var1 = 'http://127.0.0.2:8080/input-685_page-1.html#c3569734';
		} catch (e) {console.log(e)}
		...
		try {
			var func1_var5 = await self.clients.matchAll();
		} catch (e) {console.log(e)}
...
async function func1_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, '939a3267');
		...
		try {
			var func1_var7 = {handleEvent: func1_func0};
		} catch (e) {console.log(e)}

		try {
			var func1_var8 = await self.cookieStore.removeEventListener(func1_var6,func1_var7);
		} catch (e) {console.log(e)}

		try {
			var func1_var9 = 'http://127.0.0.2:8080/input-685_page-1.html#a9276921';
		} catch (e) {console.log(e)}

		try {
			var func1_var10 = false;
		} catch (e) {console.log(e)}
		...
		try {
			var func1_var12 = await event.initEvent(func1_var9,func1_var10,func1_var11);
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '50d3ad89');
...
async function func2_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, 'e652aaf4');
...
async function func2_func1(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, 'f50a89cd');

			} catch (e) {console.log(e)}

			try {
				var func2_func1_var0 = 'http://127.0.0.2:8080/input-685_page-2.html#30194c17';
			} catch (e) {console.log(e)}

async function func2_func1_func0(event) {
				try {
					check_site_violation('http://127.0.0.2:8080', location.origin, '6da933f2');

				} catch (e) {console.log(e)}

				try {
					var func2_func1_func0_var0 = true;
				} catch (e) {console.log(e)}

				try {
					event.returnValue = func2_func1_func0_var0;
				} catch (e) {console.log(e)}

				try {
					var func2_func1_func0_var1 = '8477';
				} catch (e) {console.log(e)}

				try {
					var func2_func1_func0_var2 = await self.clients.get(func2_func1_func0_var1);
				} catch (e) {console.log(e)}

				try {
					var func2_func1_func0_var4 = 'strict';
				} catch (e) {console.log(e)}

				try {
					var func2_func1_func0_var3 = {name: func2_func1_func0_var1, domain: func2_func1_func0_var1, path: func2_func1_func0_var1, secure: func2_func1_func0_var0, sameSite: func2_func1_func0_var4, };
				} catch (e) {console.log(e)}

				try {
					var func2_func1_func0_var5 = await self.cookieStore.delete(func2_func1_func0_var3);
				} catch (e) {console.log(e)}

				try {
					var func2_func1_func0_var6 = undefined;
				} catch (e) {console.log(e)}

				return func2_func1_func0_var6;
			}

			try {
				var func2_func1_var1 = {handleEvent: func2_func1_func0};
			} catch (e) {console.log(e)}

			try {
				var func2_func1_var2 = await self.cookieStore.removeEventListener(func2_func1_var0,func2_func1_var1,'');
			} catch (e) {console.log(e)}

			try {
				var func2_func1_var3 = await self.clients.claim();
			} catch (e) {console.log(e)}

			try {
				var func2_func1_var4 = undefined;
			} catch (e) {console.log(e)}

			return func2_func1_var4;
		}

		try {
			var func2_var4 = {handleEvent: func2_func1};
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '5128756c');
		...
		try {
			var func3_var2 = await func3_var1.json();
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var4 = await func3_var1.blob();
		} catch (e) {console.log(e)}

		try {
			var func3_var6 = 'worker';
		} catch (e) {console.log(e)}

		try {
			var func3_var5 = {includeUncontrolled: func3_var0, type: func3_var6, };
		} catch (e) {console.log(e)}

		try {
			var func3_var7 = await self.clients.matchAll(func3_var5);
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-0b8a4556] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-cc7ddb7c] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '7114a9af');
