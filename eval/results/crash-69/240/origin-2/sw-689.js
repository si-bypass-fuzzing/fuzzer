...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'e048f53a');
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'f7423649');
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '4abf56c3');
...
async function func2_func0_func0(event) {
				...
				try {
					var func2_func0_func0_var2 = 'http://127.0.0.2:8080/input-689_page-2.html#25187ad6';
				} catch (e) {console.log(e)}
				...
				try {
					var func2_func0_func0_var4 = await self.clients.claim();
				} catch (e) {console.log(e)}

				try {
					var func2_func0_func0_var5 = false;
				} catch (e) {console.log(e)}

				try {
					event.returnValue = func2_func0_func0_var5;
				} catch (e) {console.log(e)}

				try {
					var func2_func0_func0_var6 = undefined;
				} catch (e) {console.log(e)}

				return func2_func0_func0_var6;
			}

			try {
				var func2_func0_var5 = {handleEvent: func2_func0_func0};
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var6 = await self.cookieStore.removeEventListener(func2_func0_var4,func2_func0_var5,func2_func0_var1);
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var7 = {includeUncontrolled: func2_func0_var1, };
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var8 = await self.clients.matchAll(func2_func0_var7);
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var9 = 'http://127.0.0.1:8080/input-689_page-1.html#ccb92e7f';
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var10 = await self.clients.openWindow(func2_func0_var9);
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var11 = 'http://127.0.0.2:8080/input-689_page-2.html#fd93a156';
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var12 = await self.clients.openWindow(func2_func0_var11);
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var13 = await event.composedPath();
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var14 = await func2_func0_var10.focus();
			} catch (e) {console.log(e)}
		...
		try {
			var func2_var4 = await self.cookieStore.removeEventListener(func2_var2,func2_var3,'');
		} catch (e) {console.log(e)}

		try {
			var func2_var5 = {name: func2_var0, value: func2_var0, };
		} catch (e) {console.log(e)}

		try {
			var func2_var6 = await self.cookieStore.set(func2_var5);
		} catch (e) {console.log(e)}
		...
		try {
			var func2_var8 = await self.clients.get(func2_var7);
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'd7e6fe4c');
		...
		try {
			var func3_var3 = 'starts-with';
		} catch (e) {console.log(e)}

		try {
			var func3_var2 = {name: func3_var0, matchType: func3_var3, };
		} catch (e) {console.log(e)}

		try {
			var func3_var4 = await self.cookieStore.getAll(func3_var2);
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var7 = 'http://127.0.0.2:8080/input-689_page-2.html#3e1fc0c1';
		} catch (e) {console.log(e)}

		try {
			var func3_var6 = await self.clients.openWindow(func3_var7);
		} catch (e) {console.log(e)}

		try {
			var func3_var8 = await func3_var6.focus();
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-b39f344b] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-d879a193] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '4a9598a2');
		...
		try {
			var func4_var1 = 'http://127.0.0.1:8080/input-689_page-2.html#a37863f6';
		} catch (e) {console.log(e)}
		...
		try {
			event.respondWith(fetch('http://127.0.0.2:8080/input-689_page-2.html#4d6a3ec4').then((resp) => {if (resp.ok) {return resp;} else {return fetch(event.request);}}).catch((err) => {return fetch(event.request);}));
		} catch (e) {console.log(e)}
	}
	try {
		self.onfetch = func4;
