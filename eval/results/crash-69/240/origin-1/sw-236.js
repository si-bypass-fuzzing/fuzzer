...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '236ab94f');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-236_page-2.html#c7262d1a');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.1:8080/input-236_page-2.html#13666034');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.1:8080/input-236_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.2:8080/input-236_page-2.html#80791c7d');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-236_page-1.html#00ede5a8');
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var2 = await event.composedPath();
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var6 = await event.initEvent(func0_var3,func0_var4,func0_var5);
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '0603201b');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.1:8080/input-236_page-2.html');
		} catch (e) {console.log(e)}

async function func2_func0(event) {
			try {
				check_site_violation('http://127.0.0.1:8080', location.origin, '36c37783');

			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_url('http://127.0.0.2:8080/input-236_page-1.html#748deeea');
			} catch (e) {console.log(e)}
			...
			try {
				IPCFuzzer.mutate_origin_replace_host('http://127.0.0.2:8080/input-236_page-1.html');
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var1 = false;
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var2 = 'all';
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var0 = {includeUncontrolled: func2_func0_var1, type: func2_func0_var2, };
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var3 = await self.clients.matchAll(func2_func0_var0);
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-236_page-1.html#6b13d905');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.1:8080/input-236_page-1.html');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-236_page-1.html#d4534f1e');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.2:8080/input-236_page-2.html');
			} catch (e) {console.log(e)}
		...
		try {
			self.onbackgroundfetchabort = func2_func0;
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-236_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.1:8080/input-236_page-2.html#21a81ae3');
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '65e08076');
		...
		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.1:8080/input-236_page-1.html');
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var2 = {includeUncontrolled: func3_var3, };
		} catch (e) {console.log(e)}

		try {
			var func3_var4 = await self.clients.matchAll(func3_var2);
		} catch (e) {console.log(e)}

		try {
			var func3_var5 = 'http://127.0.0.1:8080/input-236_page-2.html#675aeefc';
		} catch (e) {console.log(e)}

		try {
			var func3_var6 = await self.cookieStore.delete(func3_var5);
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-c53eadfc] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-cda2155b] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'ab9cfa0e');
...
async function func4_func0(event) {
			try {
				check_site_violation('http://127.0.0.1:8080', location.origin, '0676b39e');

			} catch (e) {console.log(e)}

			try {
				var func4_func0_var1 = true;
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var0 = {includeUncontrolled: func4_func0_var1, };
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var2 = await self.clients.matchAll(func4_func0_var0);
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.1:8080/input-236_page-2.html');
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var3 = 'http://127.0.0.1:8080/input-236_page-1.html#78c30ec7';
			} catch (e) {console.log(e)}
			...
			try {
				IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.2:8080/input-236_page-1.html');
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var5 = await event.composedPath();
			} catch (e) {console.log(e)}
			...
			try {
				var func4_func0_var6 = await event.stopPropagation();
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_site_for_cookies('http://127.0.0.2:8080/input-236_page-1.html#b12ae0be');
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var7 = await self.cookieStore.subscribeToChanges(func4_func0_var5);
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var8 = undefined;
			} catch (e) {console.log(e)}

			return func4_func0_var8;
		}

		try {
			self.onsync = func4_func0;
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.1:8080/input-236_page-2.html#a506f41e');
		} catch (e) {console.log(e)}
		...
		try {
			event.respondWith(fetch('http://127.0.0.2:8080/input-236_page-2.html#ef5c4d35').then((resp) => {if (resp.ok) {return resp;} else {return fetch(event.request);}}).catch((err) => {return fetch(event.request);}));
		} catch (e) {console.log(e)}
	}
	try {
		self.onfetch = func4;
