...
async function func0_func0(event) {
			...
			try {
				IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-690_page-2.html#c387383e');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_url_replace_host('http://127.0.0.1:8080/input-690_page-1.html');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-690_page-1.html#6b810908');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.1:8080/input-690_page-1.html');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-690_page-2.html#c3d3dbd1');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.1:8080/input-690_page-1.html');
			} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.1:8080/input-690_page-1.html');
		} catch (e) {console.log(e)}

		try {
			var func0_var3 = 'http://127.0.0.2:8080/input-690_page-1.html#6794ccd5';
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var6 = await event.waitUntil(func0_var4);
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var8 = await self.clients.get(func0_var7);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.2:8080/input-690_page-2.html');
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'f0870b48');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-690_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-690_page-2.html#a07282ef');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.1:8080/input-690_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-690_page-1.html#2f477ca8');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.2:8080/input-690_page-1.html#4e8b6471');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.2:8080/input-690_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.2:8080/input-690_page-2.html');
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'd40fb0d2');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.1:8080/input-690_page-1.html#beea5678');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-690_page-2.html');
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '0d8a351c');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.1:8080/input-690_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-690_page-1.html#fa3d10ff');
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var3 = await self.clients.claim();
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.2:8080/input-690_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.1:8080/input-690_page-1.html#1bfc317a');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.1:8080/input-690_page-1.html#d37a2e74');
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-7c36a1e4] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-743f0474] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'da7c3071');
