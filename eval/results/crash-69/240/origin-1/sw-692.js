...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '9de4f165');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-692_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.2:8080/input-692_page-1.html');
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var4 = await event.waitUntil(func0_var3);
		} catch (e) {console.log(e)}

		try {
			var func0_var5 = await event.waitUntil(func0_var3);
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var6 = {name: self.origin, domain: self.origin, path: self.origin, secure: func0_var1, sameSite: func0_var7, };
		} catch (e) {console.log(e)}

		try {
			var func0_var8 = await self.cookieStore.delete(func0_var6);
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '4858c652');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.1:8080/input-692_page-1.html#43a54b6a');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-692_page-1.html#9a3009f4');
		} catch (e) {console.log(e)}
...
async function func1_func0(event) {
			try {
				check_site_violation('http://127.0.0.1:8080', location.origin, '3f376a33');
			...
			try {
				var func1_func0_var1 = 'foo';
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var3 = 'lax';
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var2 = {expires: Infinity, domain: func1_func0_var0, httpOnly: func1_var1, sameSite: func1_func0_var3, };
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var4 = await self.cookieStore.set(func1_func0_var0,func1_func0_var1,func1_func0_var2);
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.1:8080/input-692_page-1.html');
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var5 = 'http://127.0.0.1:8080/input-692_page-1.html#e54e7b05';
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var6 = false;
			} catch (e) {console.log(e)}
			...
			try {
				var func1_func0_var8 = await event.initEvent(func1_func0_var5,func1_func0_var6,func1_func0_var7);
			} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.1:8080/input-692_page-2.html#f4292b6b');
		} catch (e) {console.log(e)}

		try {
			var func1_var4 = await self.cookieStore.dispatchEvent(event);
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'b71f73ba');
		...
		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.2:8080/input-692_page-2.html');
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'fd3eb808');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.1:8080/input-692_page-2.html');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.1:8080/input-692_page-1.html');
		} catch (e) {console.log(e)}

		try {
			var func3_var1 = await event.stopImmediatePropagation();
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.2:8080/input-692_page-2.html#98248f07');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-692_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.1:8080/input-692_page-1.html');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-692_page-2.html#edbf50d4');
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-746c2fcd] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-5c2ab3c1] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'b34f4948');
		...
		try {
			var func4_var4 = 'http://127.0.0.2:8080/input-692_page-2.html#819e79e2';
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var13 = 'equals';
		} catch (e) {console.log(e)}

		try {
			var func4_var12 = {name: func4_var4, url: func4_var4, matchType: func4_var13, };
		} catch (e) {console.log(e)}

		try {
			var func4_var14 = await self.cookieStore.getAll(func4_var12);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.2:8080/input-692_page-1.html');
		} catch (e) {console.log(e)}
		...
		try {
			event.respondWith(fetch('http://127.0.0.1:8080/input-692_page-1.html#3d37b1b7').then((resp) => {if (resp.ok) {return resp;} else {return fetch(event.request);}}).catch((err) => {return fetch(event.request);}));
		} catch (e) {console.log(e)}
	}
	try {
		self.onfetch = func4;
