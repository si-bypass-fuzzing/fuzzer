...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'bcc68d77');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.1:8080/input-239_page-1.html#3e392a7d');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.2:8080/input-239_page-1.html');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.1:8080/input-239_page-2.html#4118babf');
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '71ebe2cf');
		...
		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-239_page-1.html#8b5ba180');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.2:8080/input-239_page-2.html');
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '4273fa7c');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-239_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.1:8080/input-239_page-1.html');
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'e023080d');
		...
		try {
			IPCFuzzer.mutate_url('http://127.0.0.2:8080/input-239_page-2.html#a6642c94');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.1:8080/input-239_page-1.html');
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-c234da51] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-b4cd5e2b] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'c6154ca5');
...
async function func4_func0(event) {
			...
			try {
				var func4_func0_var2 = 'http://127.0.0.1:8080/input-239_page-2.html#0fb66e9b';
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var3 = await self.importScripts(func4_func0_var2);
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var4 = await event.stopImmediatePropagation();
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var5 = await self.clients.matchAll(func4_var0);
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var6 = undefined;
			} catch (e) {console.log(e)}

			return func4_func0_var6;
		}

		try {
			self.onnotificationclick = func4_func0;
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.2:8080/input-239_page-2.html');
		} catch (e) {console.log(e)}
