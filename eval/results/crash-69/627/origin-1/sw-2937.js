...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '96ce18ba');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.2:8080/input-2936_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.1:8080/input-2936_page-1.html');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_url('http://127.0.0.2:8080/input-2936_page-2.html#73f3639f');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.2:8080/input-2936_page-2.html');
		} catch (e) {console.log(e)}

		try {
			var func0_var4 = await self.clients.claim();
		} catch (e) {console.log(e)}
...
async function func2(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '82d2bc2e');
		...
		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-2937_page-2.html#d4bf78d1');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.2:8080/input-2937_page-2.html#8df65183');
		} catch (e) {console.log(e)}

		try {
			var func2_var1 = 'http://127.0.0.1:8080/input-2937_page-2.html#e83427af';
		} catch (e) {console.log(e)}

		try {
			var func2_var2 = await self.clients.openWindow(func2_var1);
		} catch (e) {console.log(e)}
...
async function func2_func0(event) {
			try {
				check_site_violation('http://127.0.0.1:8080', location.origin, '4b068e37');

			} catch (e) {console.log(e)}

			try {
				var func2_func0_var0 = 3;
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var1 = new Array(func2_func0_var0);
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var2 = await self.cookieStore.subscribeToChanges(func2_func0_var1);
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_origin_replace_host('http://127.0.0.2:8080/input-2937_page-1.html');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-2937_page-2.html');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_origin_replace_host('http://127.0.0.1:8080/input-2937_page-1.html');
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var3 = await event.preventDefault();
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var4 = await event.waitUntil(func2_func0_var2);
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var5 = await event.stopImmediatePropagation();
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var6 = await event.composedPath();
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_origin_replace_host('http://127.0.0.2:8080/input-2937_page-2.html');
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var7 = 'http://127.0.0.1:8080/input-2937_page-2.html#766c2ca8';
			} catch (e) {console.log(e)}
			...
			try {
				var func2_func0_var10 = 'unrestricted';
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var9 = {expires: func2_func0_var0, domain: func2_func0_var7, path: func2_func0_var7, secure: func2_var0, httpOnly: func2_var0, sameSite: func2_func0_var10, };
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var11 = await self.cookieStore.set(func2_func0_var7,func2_func0_var8,func2_func0_var9);
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var12 = await func2_var2.postMessage(event,func2_func0_var1);
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var13 = await event.stopImmediatePropagation();
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var14 = undefined;
			} catch (e) {console.log(e)}

			return func2_func0_var14;
		}
		...
		try {
			var func2_var5 = await self.cookieStore.addEventListener(func2_var3,func2_var4,func2_var0);
		} catch (e) {console.log(e)}
		...
		try {
			var func2_var7 = await self.cookieStore.get(func2_var6);
		} catch (e) {console.log(e)}
...
async function func3(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '5f57a9ae');
		...
		try {
			var func3_var4 = 'sharedworker';
		} catch (e) {console.log(e)}

		try {
			var func3_var2 = {includeUncontrolled: func3_var3, type: func3_var4, };
		} catch (e) {console.log(e)}

		try {
			var func3_var5 = await self.clients.matchAll(func3_var2);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.1:8080/input-2937_page-1.html#7767ed10');
		} catch (e) {console.log(e)}
	...
	try {
		self.onactivate = func3;
	} catch (e) {console.log(e)}
async function func4(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'ffd732ed');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.2:8080/input-2937_page-1.html#9a5c0752');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.2:8080/input-2937_page-1.html#f8848113');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-2937_page-1.html');
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var1 = await self.cookieStore.getAll(func4_var0);
		} catch (e) {console.log(e)}
...
async function func6(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-015afb3d] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-7839f1c5] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'bce3e243');

		} catch (e) {console.log(e)}

		try {
			var func6_var0 = new Promise(eval);
		} catch (e) {console.log(e)}

		try {
			var func6_var1 = await event.waitUntil(func6_var0);
		} catch (e) {console.log(e)}

		try {
			var func6_var2 = await event.stopImmediatePropagation();
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-2937_page-2.html#c3364607');
		} catch (e) {console.log(e)}
		...
		try {
			var func6_var3 = undefined;
		} catch (e) {console.log(e)}

		try {
			event.respondWith(fetch('http://127.0.0.1:8080/input-2937_page-2.html#509c123f').then((resp) => {if (resp.ok) {return resp;} else {return fetch(event.request);}}).catch((err) => {return fetch(event.request);}));
		} catch (e) {console.log(e)}
	}
	try {
		self.onfetch = func6;
