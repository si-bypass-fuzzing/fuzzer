...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '62824185');
		...
		try {
			var func0_var3 = 'same-origin';
		} catch (e) {console.log(e)}

		try {
			var func0_var4 = 'no-cors';
		} catch (e) {console.log(e)}

		try {
			var func0_var5 = 'same-origin';
		} catch (e) {console.log(e)}

		try {
			var func0_var6 = 'reload';
		} catch (e) {console.log(e)}

		try {
			var func0_var7 = 'follow';
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var2 = {method: func0_var0, headers: '', body: func0_var0, referrer: func0_var0, referrerPolicy: func0_var3, mode: func0_var4, credentials: func0_var5, cache: func0_var6, redirect: func0_var7, integrity: func0_var0, keepalive: func0_var8, window: event, };
		} catch (e) {console.log(e)}

		try {
			var func0_var9 = await self.fetch(func0_var0,func0_var2);
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'f9eccaf8');
		...
		try {
			var func1_var3 = 'http://127.0.0.2:8080/input-624_page-1.html#75aa5da3';
		} catch (e) {console.log(e)}

		try {
			var func1_var4 = await func1_var1.navigate(func1_var3);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.1:8080/input-624_page-1.html#fad63ac5');
		} catch (e) {console.log(e)}

		try {
			var func1_var5 = new Array(event);
		} catch (e) {console.log(e)}

		try {
			var func1_var6 = await func1_var1.postMessage(event,func1_var5);
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '52227827');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-624_page-1.html#daa3c19f');
		} catch (e) {console.log(e)}

		try {
			var func2_var0 = 'http://127.0.0.2:8080/input-624_page-2.html#3bd10664';
		} catch (e) {console.log(e)}

async function func2_func0(event) {
			try {
				check_site_violation('http://127.0.0.1:8080', location.origin, 'b4256f55');

			} catch (e) {console.log(e)}

			try {
				var func2_func0_var1 = 'starts-with';
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var0 = {name: self.origin, url: self.origin, matchType: func2_func0_var1, };
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var2 = await self.cookieStore.getAll(func2_func0_var0);
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var3 = 'http://127.0.0.2:8080/input-624_page-2.html#8452324b';
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var4 = await self.cookieStore.delete(func2_func0_var3);
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-624_page-1.html#4ca1f6e2');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_site_for_cookies('http://127.0.0.2:8080/input-624_page-2.html#dc3c98e0');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_url('http://127.0.0.1:8080/input-624_page-2.html#db300926');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.2:8080/input-624_page-1.html');
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var5 = await event.composedPath();
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var7 = 'flipY';
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var8 = 'default';
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var9 = 'low';
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var6 = {imageOrientation: func2_func0_var7, colorSpaceConversion: func2_func0_var8, resizeWidth: Infinity, resizeHeight: Infinity, resizeQuality: func2_func0_var9, };
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var10 = await self.createImageBitmap('',func2_func0_var6);
			} catch (e) {console.log(e)}
		...
		try {
			event.returnValue = func2_var3;
		} catch (e) {console.log(e)}

		try {
			var func2_var4 = {name: func2_var0, value: func2_var0, };
		} catch (e) {console.log(e)}

		try {
			var func2_var5 = await self.cookieStore.set(func2_var4);
		} catch (e) {console.log(e)}

		try {
			var func2_var6 = {includeUncontrolled: func2_var3, };
		} catch (e) {console.log(e)}

		try {
			var func2_var7 = await self.clients.matchAll(func2_var6);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.1:8080/input-624_page-2.html');
		} catch (e) {console.log(e)}
		...
		try {
			var func2_var9 = await self.cookieStore.addEventListener(func2_var8,func2_var1,func2_var3);
		} catch (e) {console.log(e)}
		...
		try {
			var func2_var12 = await event.initMessageEvent(func2_var10,func2_var11);
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'a9ffdc6f');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.2:8080/input-624_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.2:8080/input-624_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.1:8080/input-624_page-1.html');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.1:8080/input-624_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.2:8080/input-624_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.1:8080/input-624_page-2.html#88489e9f');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.1:8080/input-624_page-2.html#8289e365');
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-01b82771] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-ec9d562b] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '02aeaa25');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.1:8080/input-624_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.1:8080/input-624_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-624_page-1.html');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.2:8080/input-624_page-2.html#51270b3b');
		} catch (e) {console.log(e)}

		try {
			var func4_var1 = 'http://127.0.0.2:8080/input-624_page-1.html#a6da2ebe';
		} catch (e) {console.log(e)}
