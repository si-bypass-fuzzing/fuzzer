...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '64bbabe9');
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '3f24bdcd');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.2:8080/input-656_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-656_page-2.html');
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'afa97772');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-656_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-656_page-2.html#bd395afd');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.2:8080/input-656_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-656_page-2.html#65e2129e');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.1:8080/input-656_page-2.html#da40fa74');
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '73f17c5a');
		...
		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.1:8080/input-656_page-2.html#d33c8fcb');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-656_page-1.html#fcdfa1c8');
		} catch (e) {console.log(e)}
...
async function func3_func0(event) {
			try {
				check_site_violation('http://127.0.0.1:8080', location.origin, 'ab1fbe01');

			} catch (e) {console.log(e)}

			try {
				var func3_func0_var0 = '9624';
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var1 = await self.clients.get(func3_func0_var0);
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var3 = false;
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var4 = 'sharedworker';
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var2 = {includeUncontrolled: func3_func0_var3, type: func3_func0_var4, };
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var5 = await self.clients.matchAll(func3_func0_var2);
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var7 = 'http://127.0.0.1:8080/input-656_page-2.html#f70cc656';
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var6 = await self.clients.openWindow(func3_func0_var7);
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var8 = await func3_func0_var6.focus();
			} catch (e) {console.log(e)}
			...
			try {
				event.returnValue = func3_func0_var9;
			} catch (e) {console.log(e)}
			...
			try {
				var func3_func0_var10 = 'http://127.0.0.2:8080/input-656_page-1.html#1e4ced0e';
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var11 = await self.cookieStore.delete(func3_func0_var10);
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var12 = new Array(event);
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var13 = await func3_func0_var6.postMessage(event,func3_func0_var12);
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var14 = undefined;
			} catch (e) {console.log(e)}

			return func3_func0_var14;
		}
		...
		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.2:8080/input-656_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.1:8080/input-656_page-1.html');
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-73f8ffd4] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-9650ed5a] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '043f8b48');
		...
		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.1:8080/input-656_page-1.html#3f419aa8');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.1:8080/input-656_page-1.html');
		} catch (e) {console.log(e)}
