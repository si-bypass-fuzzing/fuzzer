...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '82e8fa98');
		...
		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.2:8080/input-617_page-1.html#48616c9e');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.2:8080/input-617_page-1.html#11267773');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.2:8080/input-617_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.1:8080/input-617_page-1.html');
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '86e6ee79');
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '890077ce');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.1:8080/input-617_page-1.html#f6153cb1');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.1:8080/input-617_page-1.html#17567d78');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.2:8080/input-617_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.2:8080/input-617_page-2.html#2d5e4db2');
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '16e2321e');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.2:8080/input-617_page-2.html#902ed46a');
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var4 = 'http://127.0.0.1:8080/input-617_page-2.html#0be98b8e';
		} catch (e) {console.log(e)}

async function func3_func0(event) {
			try {
				check_site_violation('http://127.0.0.1:8080', location.origin, '93f83b91');

			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_schemeful_site('http://127.0.0.1:8080/input-617_page-1.html#6fbccf39');
			} catch (e) {console.log(e)}
			...
			try {
				var func3_func0_var2 = 'worker';
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var1 = {includeUncontrolled: func3_func0_var0, type: func3_func0_var2, };
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var3 = await self.clients.matchAll(func3_func0_var1);
			} catch (e) {console.log(e)}
			...
			try {
				IPCFuzzer.mutate_url('http://127.0.0.1:8080/input-617_page-2.html#81545c7c');
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var4 = 56;
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var5 = new Array(func3_func0_var4);
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var6 = await self.cookieStore.subscribeToChanges(func3_func0_var5);
			} catch (e) {console.log(e)}
		...
		try {
			var func3_var5 = {handleEvent: func3_func0};
		} catch (e) {console.log(e)}

		try {
			var func3_var6 = await self.cookieStore.removeEventListener(func3_var4,func3_var5,func3_var1);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.1:8080/input-617_page-2.html');
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-1eec96b3] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-90742888] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'd6e7e1d5');

		} catch (e) {console.log(e)}

		try {
			var func4_var0 = 'http://127.0.0.1:8080/input-617_page-2.html#754b57cc';
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.1:8080/input-617_page-1.html');
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var2 = 'http://127.0.0.2:8080/input-617_page-1.html#6d2f9f84';
		} catch (e) {console.log(e)}

		try {
			self.origin = func4_var2;
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.1:8080/input-617_page-2.html');
		} catch (e) {console.log(e)}
