...
async function func0(event) {
		...
		try {
			IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-654_page-1.html#acb1b640');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.1:8080/input-654_page-2.html');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-654_page-1.html#86599b61');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-654_page-1.html#2c208f9b');
		} catch (e) {console.log(e)}

async function func0_func0(event) {
			try {
				check_site_violation('http://127.0.0.1:8080', location.origin, '3b5457af');
			...
			try {
				var func0_func0_var2 = {name: func0_func0_var1, value: func0_func0_var1, };
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var3 = await self.cookieStore.set(func0_func0_var2);
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var4 = await func0_func0_var0.text();
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-654_page-1.html#48d932aa');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.2:8080/input-654_page-2.html');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_url_replace_host('http://127.0.0.2:8080/input-654_page-1.html');
			} catch (e) {console.log(e)}
			...
			try {
				var func0_func0_var6 = await self.cookieStore.addEventListener(func0_func0_var5,null,'');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_origin_replace_host('http://127.0.0.2:8080/input-654_page-1.html');
			} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '4538f76a');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-654_page-2.html#864cd37c');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.2:8080/input-654_page-2.html');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.1:8080/input-654_page-2.html');
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'fa815d49');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.2:8080/input-654_page-1.html#ada29db1');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.1:8080/input-654_page-1.html');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_url('http://127.0.0.2:8080/input-654_page-1.html#5235ef55');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.1:8080/input-654_page-2.html');
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '58d90ada');
		...
		try {
			var func3_var5 = 'sharedworker';
		} catch (e) {console.log(e)}

		try {
			var func3_var4 = {type: func3_var5, };
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var7 = await self.clients.matchAll();
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var9 = await self.clients.get(func3_var8);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.2:8080/input-654_page-1.html');
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-f411862c] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-e559fd58] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'ecd96f71');
		...
		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-654_page-2.html#cc79e7c4');
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var2 = {name: self.origin, value: self.origin, };
		} catch (e) {console.log(e)}

		try {
			var func4_var3 = await self.cookieStore.set(func4_var2);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.1:8080/input-654_page-1.html#ab0e9972');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.2:8080/input-654_page-2.html#2131194a');
		} catch (e) {console.log(e)}

		try {
			var func4_var5 = 'equals';
		} catch (e) {console.log(e)}

		try {
			var func4_var4 = {name: self.origin, url: self.origin, matchType: func4_var5, };
		} catch (e) {console.log(e)}
