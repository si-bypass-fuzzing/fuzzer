...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '73ef9cca');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-2933_page-1.html#9462213d');
		} catch (e) {console.log(e)}

		try {
			var func0_var0 = 'http://127.0.0.2:8080/input-2933_page-2.html#a2a267ed';
		} catch (e) {console.log(e)}

async function func0_func0(event) {
			try {
				check_site_violation('http://127.0.0.1:8080', location.origin, '059e4025');

			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-2933_page-2.html#1c8e11a6');
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var0 = 'foo';
			} catch (e) {console.log(e)}
		...
		try {
			var func0_var2 = await self.cookieStore.addEventListener(func0_var0,func0_var1,'');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.2:8080/input-2933_page-1.html#35bebf44');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.2:8080/input-2933_page-1.html');
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '38ac76ab');
		...
		try {
			IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-2933_page-1.html#21f8b90a');
		} catch (e) {console.log(e)}

		try {
			var func1_var1 = 'http://127.0.0.1:8080/input-2933_page-2.html#d38a142a';
		} catch (e) {console.log(e)}

		try {
			var func1_var2 = await self.clients.openWindow(func1_var1);
		} catch (e) {console.log(e)}

		try {
			var func1_var3 = 'http://127.0.0.2:8080/input-2933_page-1.html#4a398ee4';
		} catch (e) {console.log(e)}

		try {
			var func1_var4 = await func1_var2.navigate(func1_var3);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-2933_page-1.html#b05eacc7');
		} catch (e) {console.log(e)}

		try {
			var func1_var5 = 'http://127.0.0.1:8080/input-2933_page-2.html#931284ae';
		} catch (e) {console.log(e)}

		try {
			var func1_var6 = await self.clients.openWindow(func1_var5);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-2933_page-2.html');
		} catch (e) {console.log(e)}

		try {
			var func1_var7 = await event.composedPath();
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '93b9485c');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.1:8080/input-2933_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.1:8080/input-2933_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-2933_page-2.html#a08815b6');
		} catch (e) {console.log(e)}
		...
		try {
			var func2_var0 = {name: self.origin, url: self.origin, matchType: func2_var1, };
		} catch (e) {console.log(e)}
		...
		try {
			var func2_var3 = await self.cookieStore.get(func2_var0);
		} catch (e) {console.log(e)}

		try {
			var func2_var4 = {name: self.origin, value: self.origin, };
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.2:8080/input-2933_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-2933_page-2.html#9027a8e2');
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '912c8ded');
		...
		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.2:8080/input-2933_page-2.html#8053aac3');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.1:8080/input-2933_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.1:8080/input-2933_page-1.html#01670d68');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.1:8080/input-2933_page-2.html');
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-382b403e] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-9d8962d6] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'b28dfa69');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.1:8080/input-2933_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-2933_page-1.html#6e68ad83');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.1:8080/input-2933_page-2.html#5e28527c');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.2:8080/input-2933_page-1.html');
		} catch (e) {console.log(e)}
