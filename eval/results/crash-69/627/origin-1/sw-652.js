...
async function func0(event) {
		...
		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.2:8080/input-652_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.2:8080/input-652_page-2.html#bd17a7df');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.1:8080/input-652_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-652_page-1.html#c284a00c');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.1:8080/input-652_page-1.html#049fc95d');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.2:8080/input-652_page-2.html');
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '471d934a');
		...
		try {
			var func1_var1 = new Array(func1_var0);
		} catch (e) {console.log(e)}

		try {
			var func1_var2 = await self.cookieStore.subscribeToChanges(func1_var1);
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '89d7d84e');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.1:8080/input-652_page-2.html#bd10d1ae');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.1:8080/input-652_page-1.html');
		} catch (e) {console.log(e)}
...
async function func2_func0(event) {
			try {
				check_site_violation('http://127.0.0.1:8080', location.origin, 'bb24b400');

			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_origin_replace_host('http://127.0.0.2:8080/input-652_page-1.html');
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var0 = 'http://127.0.0.1:8080/input-652_page-1.html#f18f2df4';
			} catch (e) {console.log(e)}

			try {
				var func2_func0_var1 = await self.cookieStore.get(func2_func0_var0);
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.1:8080/input-652_page-1.html');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-652_page-1.html#0eb6e4b2');
			} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-652_page-1.html#b1b59071');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.1:8080/input-652_page-2.html');
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'b80c0c76');
		...
		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.1:8080/input-652_page-2.html#32bc9801');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.2:8080/input-652_page-2.html#a42a8571');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.1:8080/input-652_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.2:8080/input-652_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.2:8080/input-652_page-2.html#bd3445f7');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.2:8080/input-652_page-1.html#20478e5f');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.1:8080/input-652_page-1.html#9681a6e7');
		} catch (e) {console.log(e)}

		try {
			var func3_var1 = 'http://127.0.0.1:8080/input-652_page-1.html#cd0eb447';
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var5 = 'http://127.0.0.1:8080/input-652_page-1.html#149449d2';
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-4b46636c] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-1d4c6522] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '0a8435be');
		...
		try {
			IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-652_page-1.html#65c11f02');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.1:8080/input-652_page-1.html');
		} catch (e) {console.log(e)}

		try {
			var func4_var1 = 'http://127.0.0.2:8080/input-652_page-1.html#41c10395';
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var3 = await event.stopImmediatePropagation();
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-652_page-2.html');
		} catch (e) {console.log(e)}

		try {
			var func4_var5 = 'http://127.0.0.1:8080/input-652_page-2.html#b3276228';
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var7 = await event.preventDefault();
		} catch (e) {console.log(e)}
