...
async function func0_func0(event) {
			...
			try {
				var func0_func0_var3 = await event.initEvent(func0_func0_var0,func0_func0_var1,func0_func0_var2);
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-650_page-2.html#737a3575');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.2:8080/input-650_page-1.html');
			} catch (e) {console.log(e)}
			...
			try {
				event.returnValue = func0_func0_var4;
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_url('http://127.0.0.1:8080/input-650_page-1.html#efbb133e');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.2:8080/input-650_page-2.html');
			} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-650_page-1.html#880458c6');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.1:8080/input-650_page-2.html');
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var0 = {name: self.origin, domain: self.origin, path: self.origin, secure: func0_var1, sameSite: func0_var2, };
		} catch (e) {console.log(e)}

		try {
			var func0_var3 = await self.cookieStore.delete(func0_var0);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-650_page-1.html#1398524e');
		} catch (e) {console.log(e)}

		try {
			var func0_var4 = 'http://127.0.0.1:8080/input-650_page-2.html#2d2eaf6e';
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var7 = await event.initEvent(func0_var4,func0_var5,func0_var6);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.1:8080/input-650_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-650_page-1.html#32afe770');
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var9 = await self.setInterval(self.origin,func0_var8,event);
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '220646d3');
		...
		try {
			var func1_var3 = await event.initEvent(func1_var0,func1_var1,func1_var2);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.2:8080/input-650_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.2:8080/input-650_page-1.html#daea9663');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-650_page-1.html#d3837a2b');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-650_page-1.html#b1fd69fd');
		} catch (e) {console.log(e)}

		try {
			var func1_var4 = 'http://127.0.0.1:8080/input-650_page-2.html#72c01225';
		} catch (e) {console.log(e)}

		try {
			var func1_var5 = 'http://127.0.0.1:8080/input-650_page-1.html#b26250ee';
		} catch (e) {console.log(e)}

		try {
			var func1_var6 = await self.cookieStore.set(func1_var4,func1_var5);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.2:8080/input-650_page-1.html#959e9b48');
		} catch (e) {console.log(e)}
...
async function func2(event) {
		...
		try {
			var func2_var2 = 'unrestricted';
		} catch (e) {console.log(e)}

		try {
			var func2_var0 = {name: self.origin, domain: self.origin, path: self.origin, secure: func2_var1, sameSite: func2_var2, };
		} catch (e) {console.log(e)}

		try {
			var func2_var3 = await self.cookieStore.delete(func2_var0);
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-650_page-1.html#8e3269c9');
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'f148da99');
		...
		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.1:8080/input-650_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.2:8080/input-650_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-650_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-650_page-1.html#d47e5cd5');
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-c1c6914c] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-78200380] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '1c550c1c');
		...
		try {
			var func4_var1 = 'http://127.0.0.2:8080/input-650_page-2.html#c75a96ba';
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-650_page-1.html#5e393691');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-650_page-1.html#f6d3f774');
		} catch (e) {console.log(e)}
