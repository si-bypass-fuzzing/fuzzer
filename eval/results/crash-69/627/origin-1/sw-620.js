...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '51bd7766');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-620_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-620_page-1.html#cb2d1cd8');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.2:8080/input-620_page-1.html#d9c190ce');
		} catch (e) {console.log(e)}
...
async function func0_func0(event) {
			...
			try {
				IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.2:8080/input-620_page-2.html');
			} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '79d9418d');
		...
		try {
			var func1_var0 = {includeUncontrolled: func1_var1, };
		} catch (e) {console.log(e)}

		try {
			var func1_var2 = await self.clients.matchAll(func1_var0);
		} catch (e) {console.log(e)}
		...
		try {
			var func1_var5 = await self.cookieStore.subscribeToChanges(func1_var4);
		} catch (e) {console.log(e)}

		try {
			var func1_var7 = 'equals';
		} catch (e) {console.log(e)}

		try {
			var func1_var6 = {name: self.origin, url: self.origin, matchType: func1_var7, };
		} catch (e) {console.log(e)}

		try {
			var func1_var8 = await self.cookieStore.getAll(func1_var6);
		} catch (e) {console.log(e)}

		try {
			var func1_var9 = await self.clients.matchAll(func1_var0);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.1:8080/input-620_page-2.html#fb2c0326');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-620_page-2.html#252a8515');
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '5f61c562');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.2:8080/input-620_page-2.html#7351476d');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-620_page-2.html#e3670f40');
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '059d718b');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.1:8080/input-620_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.2:8080/input-620_page-1.html');
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var3 = 'http://127.0.0.2:8080/input-620_page-2.html#41ec9bd0';
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-620_page-2.html#b94396c1');
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-1287361b] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-728ca72e] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '1f7fd222');
		...
		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-620_page-1.html#923e5cf5');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.1:8080/input-620_page-1.html#4f7554e1');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.1:8080/input-620_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.1:8080/input-620_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.1:8080/input-620_page-2.html#a4a34569');
		} catch (e) {console.log(e)}
