...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '662932fe');
		...
		try {
			IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-622_page-2.html#278f6ed3');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.1:8080/input-622_page-2.html');
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var4 = 'http://127.0.0.1:8080/input-622_page-2.html#bf9f74af';
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var6 = {expires: Infinity, domain: self.origin, path: self.origin, secure: func0_var7, httpOnly: func0_var7, sameSite: func0_var8, };
		} catch (e) {console.log(e)}

		try {
			var func0_var9 = await self.cookieStore.set(func0_var4,func0_var5,func0_var6);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.2:8080/input-622_page-2.html#cc6386dc');
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '33c05a61');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.2:8080/input-622_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.1:8080/input-622_page-1.html#2afaac88');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.1:8080/input-622_page-2.html');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.1:8080/input-622_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.1:8080/input-622_page-1.html#f392af3d');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.1:8080/input-622_page-1.html');
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '150390b9');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-622_page-1.html');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_url('http://127.0.0.1:8080/input-622_page-1.html#c83e77f3');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.2:8080/input-622_page-1.html#3d3c5510');
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var2 = await func3_var1.arrayBuffer();
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-622_page-1.html#70270e2b');
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-d4f84e91] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-ed181db2] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			var func4_var2 = {name: func4_var0, domain: func4_var0, path: func4_var0, secure: func4_var3, };
		} catch (e) {console.log(e)}

		try {
			var func4_var4 = await self.cookieStore.delete(func4_var2);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.2:8080/input-622_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.1:8080/input-622_page-1.html');
		} catch (e) {console.log(e)}

		try {
			var func4_var5 = 'http://127.0.0.2:8080/input-622_page-2.html#f6350a61';
		} catch (e) {console.log(e)}

		try {
			var func4_var6 = false;
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var8 = await event.initEvent(func4_var5,func4_var6,func4_var7);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.2:8080/input-622_page-2.html#b5232095');
		} catch (e) {console.log(e)}
