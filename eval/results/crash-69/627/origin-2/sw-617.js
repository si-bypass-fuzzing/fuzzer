...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'e543e7d6');
		...
		try {
			var func0_var4 = 'http://127.0.0.1:8080/input-617_page-2.html#d6715a0c';
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var14 = await event.initEvent(func0_var11,func0_var12,func0_var13);
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '62477772');
...
async function func1_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, '133e275b');
			...
			try {
				var func1_func0_var4 = await event.composedPath();
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var5 = await event.preventDefault();
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var6 = await event.stopImmediatePropagation();
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var7 = await event.preventDefault();
			} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '14ba031f');
...
async function func2_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, '235ee558');
			...
			try {
				event.returnValue = func2_func0_var1;
			} catch (e) {console.log(e)}
		...
		try {
			self.oncanmakepayment = func2_func0;
		} catch (e) {console.log(e)}

async function func2_func1(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, 'fa0e21b9');

			} catch (e) {console.log(e)}

			try {
				var func2_func1_var0 = await event.waitUntil(func2_var2);
			} catch (e) {console.log(e)}

			try {
				var func2_func1_var1 = false;
			} catch (e) {console.log(e)}
			...
			try {
				var func2_func1_var2 = undefined;
			} catch (e) {console.log(e)}

			return func2_func1_var2;
		}

		try {
			self.onsync = func2_func1;
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'f21ff420');
		...
		try {
			var func3_var1 = await self.cookieStore.get(func3_var0);
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var4 = {includeUncontrolled: func3_var3, type: func3_var5, };
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var7 = {name: func3_var0, value: func3_var0, };
		} catch (e) {console.log(e)}

		try {
			var func3_var8 = await self.cookieStore.set(func3_var7);
		} catch (e) {console.log(e)}

		try {
			var func3_var10 = 'starts-with';
		} catch (e) {console.log(e)}

		try {
			var func3_var9 = {name: func3_var0, url: func3_var0, matchType: func3_var10, };
		} catch (e) {console.log(e)}

		try {
			var func3_var11 = await self.cookieStore.getAll(func3_var9);
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-9491a1fb] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-640a0550] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '6fda2f19');
