...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '87b7dbb9');
		...
		try {
			var func0_var7 = await self.cookieStore.delete(func0_var6);
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '2d580476');
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '13d94ae5');
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'dd6a2982');
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-b828c5e7] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-3e52b57e] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '8a6c12ad');
		...
		try {
			self.onpaymentrequest = func4_func0;
		} catch (e) {console.log(e)}

		try {
			var func4_var4 = 'http://127.0.0.2:8080/input-2931_page-2.html#90082a0c';
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var6 = await func4_var5.focus();
		} catch (e) {console.log(e)}

		try {
			var func4_var7 = 'http://127.0.0.2:8080/input-2931_page-1.html#4b3148ea';
		} catch (e) {console.log(e)}

		try {
			var func4_var8 = await self.cookieStore.addEventListener(func4_var7,null,func4_var1);
		} catch (e) {console.log(e)}

		try {
			var func4_var9 = await self.clients.matchAll();
		} catch (e) {console.log(e)}
