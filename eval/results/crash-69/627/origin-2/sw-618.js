...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'a381e060');
		...
		try {
			var func0_var6 = 'http://127.0.0.2:8080/input-618_page-1.html#7f2601df';
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '79cbb77c');

		} catch (e) {console.log(e)}

async function func1_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, '031e3cde');

			} catch (e) {console.log(e)}

			try {
				var func1_func0_var0 = 'http://127.0.0.1:8080/input-618_page-2.html#442e8a75';
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var1 = false;
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var2 = true;
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var3 = await event.initEvent(func1_func0_var0,func1_func0_var1,func1_func0_var2);
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var4 = await event.stopImmediatePropagation();
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var5 = new Promise(eval);
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var6 = await event.waitUntil(func1_func0_var5);
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var7 = await event.composedPath();
			} catch (e) {console.log(e)}
		...
		try {
			self.oncanmakepayment = func1_func0;
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '7698bf31');
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '5d650013');
		...
		try {
			var func3_var2 = {name: self.origin, matchType: func3_var3, };
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-f241734b] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-f55903cc] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '2e59754b');
...
async function func4_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, 'cffac345');
			...
			try {
				var func4_func0_var1 = await event.stopPropagation();
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var2 = await event.stopPropagation();
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var3 = await self.cookieStore.dispatchEvent(event);
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var4 = 'http://127.0.0.2:8080/input-618_page-2.html#4fd58756';
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var5 = false;
			} catch (e) {console.log(e)}
			...
			try {
				var func4_func0_var7 = await event.initEvent(func4_func0_var4,func4_func0_var5,func4_func0_var6);
			} catch (e) {console.log(e)}
		...
		try {
			var func4_var2 = await self.cookieStore.removeEventListener(func4_var0,func4_var1,'');
		} catch (e) {console.log(e)}

async function func4_func1(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, '59a3630e');

			} catch (e) {console.log(e)}

			try {
				var func4_func1_var0 = 'http://127.0.0.2:8080/input-618_page-1.html#2c983712';
			} catch (e) {console.log(e)}

			try {
				var func4_func1_var1 = await self.clients.openWindow(func4_func1_var0);
			} catch (e) {console.log(e)}

			try {
				var func4_func1_var2 = await event.composedPath();
			} catch (e) {console.log(e)}

			try {
				var func4_func1_var3 = await event.preventDefault();
			} catch (e) {console.log(e)}

			try {
				var func4_func1_var5 = false;
			} catch (e) {console.log(e)}

			try {
				var func4_func1_var4 = {includeUncontrolled: func4_func1_var5, };
			} catch (e) {console.log(e)}

			try {
				var func4_func1_var6 = await self.clients.matchAll(func4_func1_var4);
			} catch (e) {console.log(e)}

			try {
				var func4_func1_var7 = 'http://127.0.0.2:8080/input-618_page-1.html#a8e5237a';
			} catch (e) {console.log(e)}

			try {
				var func4_func1_var8 = '8bf18cb9455f4a8e8fa93d14ab5ebb5d';
			} catch (e) {console.log(e)}

			try {
				var func4_func1_var10 = 'lax';
			} catch (e) {console.log(e)}

			try {
				var func4_func1_var9 = {expires: Infinity, domain: func4_func1_var0, path: func4_func1_var0, secure: func4_func1_var5, httpOnly: func4_func1_var5, sameSite: func4_func1_var10, };
			} catch (e) {console.log(e)}

			try {
				var func4_func1_var11 = await self.cookieStore.set(func4_func1_var7,func4_func1_var8,func4_func1_var9);
			} catch (e) {console.log(e)}

			try {
				var func4_func1_var12 = await event.preventDefault();
			} catch (e) {console.log(e)}

			try {
				var func4_func1_var13 = undefined;
			} catch (e) {console.log(e)}

			return func4_func1_var13;
		}

		try {
			self.onbackgroundfetched = func4_func1;
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var7 = await event.composedPath();
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var9 = await self.cookieStore.getAll(func4_var8);
		} catch (e) {console.log(e)}
