...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '31904ce1');
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '826d80c8');
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'e6496686');
		...
		try {
			var func3_var1 = 'http://127.0.0.2:8080/input-620_page-2.html#420813ae';
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var3 = 'http://127.0.0.1:8080/input-620_page-2.html#e7320b7d';
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var5 = 'http://127.0.0.1:8080/input-620_page-1.html#76e6188b';
		} catch (e) {console.log(e)}

		try {
			var func3_var6 = await self.cookieStore.get(func3_var5);
		} catch (e) {console.log(e)}

		try {
			var func3_var7 = await func3_var4.focus();
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-3345d7c1] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-4022c875] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'aa8fbdf0');
