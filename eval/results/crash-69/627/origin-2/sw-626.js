...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'c97015e3');

		} catch (e) {console.log(e)}

		try {
			var func0_var1 = 'starts-with';
		} catch (e) {console.log(e)}

		try {
			var func0_var0 = {name: self.origin, url: self.origin, matchType: func0_var1, };
		} catch (e) {console.log(e)}

		try {
			var func0_var2 = await self.cookieStore.get(func0_var0);
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var7 = await self.cookieStore.getAll(func0_var0);
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var9 = await event.composedPath();
		} catch (e) {console.log(e)}

		try {
			var func0_var10 = await self.cookieStore.getAll(func0_var0);
		} catch (e) {console.log(e)}

		try {
			var func0_var11 = {name: self.origin, value: self.origin, };
		} catch (e) {console.log(e)}

		try {
			var func0_var12 = await self.cookieStore.set(func0_var11);
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '118fbe42');
...
async function func1_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, '59cbc5bc');
...
async function func1_func0_func0(event) {
				try {
					check_site_violation('http://127.0.0.2:8080', location.origin, '7930e998');

				} catch (e) {console.log(e)}

				try {
					var func1_func0_func0_var0 = 'http://127.0.0.1:8080/input-626_page-2.html#5d1901af';
				} catch (e) {console.log(e)}

				try {
					var func1_func0_func0_var1 = await self.cookieStore.get(func1_func0_func0_var0);
				} catch (e) {console.log(e)}
...
async function func1_func0_func0_func0(event) {
			...
			try {
				var func1_func0_var3 = await event.stopPropagation();
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var4 = 'http://127.0.0.1:8080/input-626_page-2.html#556d00af';
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var5 = await self.importScripts(func1_func0_var4);
			} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '3a2d492c');
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '80159288');
		...
		try {
			var func3_var2 = await func3_var0.blob();
		} catch (e) {console.log(e)}

async function func3_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, 'cb69693b');
			...
			try {
				var func3_func0_var3 = true;
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var4 = 'strict';
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var2 = {expires: Infinity, domain: func3_func0_var0, path: func3_func0_var0, secure: func3_func0_var3, httpOnly: func3_func0_var3, sameSite: func3_func0_var4, };
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var5 = await self.cookieStore.set(func3_func0_var0,func3_func0_var1,func3_func0_var2);
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var6 = await func3_var0.json();
			} catch (e) {console.log(e)}
		...
		try {
			var func3_var5 = 'application/octet-stream';
		} catch (e) {console.log(e)}

		try {
			var func3_var6 = await func3_var1.slice(func3_var3,func3_var4,func3_var5);
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-656fe096] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-ce2928b0] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '073b02be');
		...
		try {
			event.respondWith(fetch('http://127.0.0.2:8080/input-626_page-2.html#f20dd627').then((resp) => {if (resp.ok) {return resp;} else {return fetch(event.request);}}).catch((err) => {return fetch(event.request);}));
		} catch (e) {console.log(e)}
	}
	try {
		self.onfetch = func4;
