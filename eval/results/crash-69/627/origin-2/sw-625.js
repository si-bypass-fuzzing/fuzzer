...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '735de890');
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'c717e282');
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '3737d761');
		...
		try {
			var func2_var4 = {name: self.origin, matchType: func2_var5, };
		} catch (e) {console.log(e)}

		try {
			var func2_var6 = await self.cookieStore.get(func2_var4);
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'ee63b0e4');
		...
		try {
			var func3_var5 = 'http://127.0.0.1:8080/input-625_page-1.html#19a2d470';
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-03ef3de2] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-5b74927a] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '4ec3dfe0');
		...
		try {
			var func4_var1 = await self.atob(func4_var0);
		} catch (e) {console.log(e)}
