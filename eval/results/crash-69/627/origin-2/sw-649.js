...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'c12dfa1f');
		...
		try {
			var func0_var1 = 'http://127.0.0.1:8080/input-649_page-1.html#2ae3ef95';
		} catch (e) {console.log(e)}

		try {
			var func0_var2 = await self.cookieStore.get(func0_var1);
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var4 = await self.cookieStore.get(func0_var3);
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var6 = await self.clearInterval(func0_var5);
		} catch (e) {console.log(e)}

		try {
			var func0_var7 = await event.waitUntil(func0_var2);
		} catch (e) {console.log(e)}

		try {
			var func0_var8 = 'http://127.0.0.2:8080/input-649_page-1.html#1a7114fa';
		} catch (e) {console.log(e)}

async function func0_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, '5777c439');
			...
			try {
				event.returnValue = func0_func0_var1;
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var2 = 'http://127.0.0.2:8080/input-649_page-2.html#8a00e272';
			} catch (e) {console.log(e)}
			...
			try {
				var func0_func0_var5 = await event.initEvent(func0_func0_var2,func0_func0_var3,func0_func0_var4);
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var6 = '2c69';
			} catch (e) {console.log(e)}
		...
		try {
			var func0_var9 = {handleEvent: func0_func0};
		} catch (e) {console.log(e)}

		try {
			var func0_var10 = await self.cookieStore.addEventListener(func0_var8,func0_var9,func0_var0);
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '86c96f7c');
		...
		try {
			var func1_var5 = 'http://127.0.0.2:8080/input-649_page-1.html#13681dc7';
		} catch (e) {console.log(e)}
		...
		try {
			var func1_var7 = await self.cookieStore.dispatchEvent(event);
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'f42e839c');
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'f085b828');
		...
		try {
			var func3_var4 = await func3_var1.text();
		} catch (e) {console.log(e)}

		try {
			var func3_var5 = await func3_var1.text();
		} catch (e) {console.log(e)}

		try {
			var func3_var6 = await func3_var1.arrayBuffer();
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-5a45d08c] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-79e76d65] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'f5b68374');

		} catch (e) {console.log(e)}

		try {
			var func4_var0 = 'http://127.0.0.1:8080/input-649_page-2.html#63b4a444';
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var3 = 'flipY';
		} catch (e) {console.log(e)}

		try {
			var func4_var4 = 'default';
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var2 = {imageOrientation: func4_var3, premultiplyAlpha: func4_var4, colorSpaceConversion: func4_var5, resizeWidth: Infinity, resizeHeight: Infinity, resizeQuality: func4_var6, };
		} catch (e) {console.log(e)}

		try {
			var func4_var7 = await self.createImageBitmap('',func4_var2);
		} catch (e) {console.log(e)}

		try {
			var func4_var8 = await event.stopImmediatePropagation();
		} catch (e) {console.log(e)}

		try {
			var func4_var9 = 'http://127.0.0.1:8080/input-649_page-1.html#1cfaad6c';
		} catch (e) {console.log(e)}

		try {
			var func4_var10 = await func4_var1.navigate(func4_var9);
		} catch (e) {console.log(e)}
