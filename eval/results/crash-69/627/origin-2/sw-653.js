...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'fef157f5');
		...
		try {
			var func0_var5 = 'http://127.0.0.1:8080/input-653_page-1.html#7fe13c5c';
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var9 = 'unrestricted';
		} catch (e) {console.log(e)}

		try {
			var func0_var7 = {expires: Infinity, domain: func0_var3, path: func0_var3, secure: func0_var8, httpOnly: func0_var8, sameSite: func0_var9, };
		} catch (e) {console.log(e)}

		try {
			var func0_var10 = await self.cookieStore.set(func0_var5,func0_var6,func0_var7);
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var11 = {includeUncontrolled: func0_var8, type: func0_var12, };
		} catch (e) {console.log(e)}

		try {
			var func0_var13 = await self.clients.matchAll(func0_var11);
		} catch (e) {console.log(e)}

		try {
			var func0_var14 = await event.waitUntil(func0_var0);
		} catch (e) {console.log(e)}

		try {
			var func0_var15 = {name: func0_var3, path: func0_var3, };
		} catch (e) {console.log(e)}

		try {
			var func0_var16 = await self.cookieStore.delete(func0_var15);
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var18 = new Array(func0_var17);
		} catch (e) {console.log(e)}

		try {
			var func0_var19 = await func0_var2.postMessage(event,func0_var18);
		} catch (e) {console.log(e)}

		try {
			var func0_var20 = true;
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var21 = 'http://127.0.0.2:8080/input-653_page-1.html#17186f14';
		} catch (e) {console.log(e)}

		try {
			var func0_var22 = await self.clients.openWindow(func0_var21);
		} catch (e) {console.log(e)}

		try {
			var func0_var23 = await event.waitUntil(func0_var0);
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'd8de3dd0');

		} catch (e) {console.log(e)}

		try {
			var func1_var0 = 'http://127.0.0.1:8080/input-653_page-1.html#ba8e9e88';
		} catch (e) {console.log(e)}
		...
		try {
			var func1_var3 = 'http://127.0.0.1:8080/input-653_page-1.html#189aef5e';
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '9e9cf093');
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '96a3f2a7');
		...
		try {
			var func3_var3 = 'http://127.0.0.2:8080/input-653_page-2.html#2193ab61';
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var7 = await func3_var0.text();
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-95cea83d] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-979e26f4] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '46717bff');
