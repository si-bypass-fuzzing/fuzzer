...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '6bd06909');
		...
		try {
			var func0_var4 = 'http://127.0.0.1:8080/input-624_page-1.html#7ee42a36';
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var10 = {expires: Infinity, domain: func0_var4, path: func0_var4, secure: func0_var5, httpOnly: func0_var5, };
		} catch (e) {console.log(e)}

		try {
			var func0_var11 = await self.cookieStore.set(func0_var8,func0_var9,func0_var10);
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'd7d890f8');
		...
		try {
			var func1_var9 = await self.clients.get(func1_var8);
		} catch (e) {console.log(e)}
...
async function func1_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, '623dc793');
			...
			try {
				var func1_func0_var1 = '171d';
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var2 = await self.clients.get(func1_func0_var1);
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var3 = await self.clients.claim();
			} catch (e) {console.log(e)}
			...
			try {
				event.returnValue = func1_func0_var4;
			} catch (e) {console.log(e)}

			try {
				var func1_func0_var5 = await self.clients.claim();
			} catch (e) {console.log(e)}
		...
		try {
			var func1_var12 = await self.cookieStore.removeEventListener(func1_var10,func1_var11,func1_var3);
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'c8ac6ca7');
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '043f10bc');
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-266c3a40] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-8ace2f15] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '7fc06c0b');

		} catch (e) {console.log(e)}

		try {
			var func4_var0 = await self.cookieStore.dispatchEvent(event);
		} catch (e) {console.log(e)}
