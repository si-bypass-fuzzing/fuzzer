...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'b99d8ac8');
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '5ca6eaf9');
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '1ed3096a');

		} catch (e) {console.log(e)}

		try {
			var func2_var1 = 'window';
		} catch (e) {console.log(e)}

		try {
			var func2_var0 = {type: func2_var1, };
		} catch (e) {console.log(e)}

		try {
			var func2_var2 = await self.clients.matchAll(func2_var0);
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'e190791c');

		} catch (e) {console.log(e)}

		try {
			var func3_var0 = new Array(event);
		} catch (e) {console.log(e)}

		try {
			var func3_var1 = await self.cookieStore.subscribeToChanges(func3_var0);
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-b61dd2e1] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-badecc3c] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, '41eb5266');

		} catch (e) {console.log(e)}

async function func4_func0(event) {
			try {
				check_site_violation('http://127.0.0.2:8080', location.origin, '8953a244');
			...
			try {
				var func4_func0_var1 = 'http://127.0.0.1:8080/input-7642_page-1.html#ccfc9127';
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var2 = false;
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var3 = true;
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var4 = await event.initEvent(func4_func0_var1,func4_func0_var2,func4_func0_var3);
			} catch (e) {console.log(e)}
			...
			try {
				var func4_func0_var6 = event.data;
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var7 = await func4_func0_var6.blob();
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var8 = await func4_func0_var6.blob();
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var9 = new Promise(eval);
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var10 = await event.waitUntil(func4_func0_var9);
			} catch (e) {console.log(e)}

			try {
				var func4_func0_var11 = undefined;
			} catch (e) {console.log(e)}

			return func4_func0_var11;
		}

		try {
			self.onpush = func4_func0;
		} catch (e) {console.log(e)}
		...
		try {
			event.respondWith(fetch('http://127.0.0.2:8080/input-7642_page-1.html#aa4b8528').then((resp) => {if (resp.ok) {return resp;} else {return fetch(event.request);}}).catch((err) => {return fetch(event.request);}));
		} catch (e) {console.log(e)}
	}
	try {
		self.onfetch = func4;
