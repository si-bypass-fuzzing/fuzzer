...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '81b0f813');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.1:8080/input-7_page-1.html');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.1:8080/input-7_page-1.html#2dd5007a');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-7_page-2.html#f2510bcf');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.1:8080/input-7_page-1.html');
		} catch (e) {console.log(e)}

		try {
			var func0_var4 = await self.clients.matchAll(func0_var0);
		} catch (e) {console.log(e)}

		try {
			var func0_var5 = await self.clients.claim();
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.1:8080/input-7_page-1.html#d8324004');
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '013922f2');
		...
		try {
			var func1_var4 = 'http://127.0.0.1:8080/input-7_page-2.html#3b17448e';
		} catch (e) {console.log(e)}

		try {
			var func1_var5 = false;
		} catch (e) {console.log(e)}
		...
		try {
			var func1_var7 = await event.initEvent(func1_var4,func1_var5,func1_var6);
		} catch (e) {console.log(e)}

		try {
			var func1_var8 = await self.clients.claim();
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.1:8080/input-7_page-2.html#bc6971c8');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.2:8080/input-7_page-2.html#159a43d3');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-7_page-2.html');
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '9018d34b');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-7_page-1.html');
		} catch (e) {console.log(e)}

		try {
			var func2_var1 = 'starts-with';
		} catch (e) {console.log(e)}
		...
		try {
			var func2_var2 = await self.cookieStore.getAll(func2_var0);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.1:8080/input-7_page-1.html');
		} catch (e) {console.log(e)}
		...
		try {
			var func2_var4 = {type: func2_var5, };
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '5b4f6f01');
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-519f6ee4] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-8364bda6] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'c0f2fbf2');
		...
		try {
			var func4_var6 = 'http://127.0.0.1:8080/input-7_page-1.html#009ba55e';
		} catch (e) {console.log(e)}

		try {
			var func4_var7 = await self.cookieStore.delete(func4_var6);
		} catch (e) {console.log(e)}
		...
		try {
			event.returnValue = func4_var11;
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.2:8080/input-7_page-1.html#46a5bf1e');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.2:8080/input-7_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.1:8080/input-7_page-2.html#5adb5a3f');
		} catch (e) {console.log(e)}
