...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '0ce3cc57');

		} catch (e) {console.log(e)}

		try {
			var func0_var0 = 'http://127.0.0.1:8080/input-5_page-2.html#948b9e43';
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var5 = await self.cookieStore.subscribeToChanges(func0_var4);
		} catch (e) {console.log(e)}

		try {
			var func0_var6 = 'http://127.0.0.2:8080/input-5_page-1.html#b35e41f9';
		} catch (e) {console.log(e)}

async function func0_func0(event) {
			try {
				check_site_violation('http://127.0.0.1:8080', location.origin, '6793288a');

			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-5_page-1.html#33920c71');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_url('http://127.0.0.2:8080/input-5_page-2.html#af4adebc');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_url('http://127.0.0.2:8080/input-5_page-1.html#e5f222d5');
			} catch (e) {console.log(e)}
			...
			try {
				IPCFuzzer.mutate_storage_key('http://127.0.0.1:8080/input-5_page-1.html#59e42601');
			} catch (e) {console.log(e)}

			try {
				var func0_func0_var1 = 'e6a5';
			} catch (e) {console.log(e)}
			...
			try {
				IPCFuzzer.mutate_url('http://127.0.0.1:8080/input-5_page-1.html#9c414734');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.2:8080/input-5_page-2.html');
			} catch (e) {console.log(e)}
		...
		try {
			var func0_var7 = {handleEvent: func0_func0};
		} catch (e) {console.log(e)}

		try {
			var func0_var8 = await self.cookieStore.removeEventListener(func0_var6,func0_var7,'');
		} catch (e) {console.log(e)}

		try {
			var func0_var9 = await event.waitUntil(func0_var1);
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.2:8080/input-5_page-2.html#2c330e75');
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'd6588879');
		...
		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.2:8080/input-5_page-1.html#28bf94e1');
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'b52b040f');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-5_page-1.html#d593099f');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.2:8080/input-5_page-1.html#003d69d5');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.2:8080/input-5_page-1.html#a28147f1');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.1:8080/input-5_page-2.html');
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '0a4f6ba0');
		...
		try {
			IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-5_page-2.html#7c517952');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.2:8080/input-5_page-2.html#8bccbfae');
		} catch (e) {console.log(e)}

		try {
			var func3_var1 = {name: self.origin, value: self.origin, };
		} catch (e) {console.log(e)}

		try {
			var func3_var2 = await self.cookieStore.set(func3_var1);
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-e5718cd5] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-cf7817d2] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'a50050bf');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.1:8080/input-5_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-5_page-1.html');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.1:8080/input-5_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.2:8080/input-5_page-2.html');
		} catch (e) {console.log(e)}
		...
		try {
			event.respondWith(fetch('http://127.0.0.2:8080/input-5_page-2.html#2d7729fc').then((resp) => {if (resp.ok) {return resp;} else {return fetch(event.request);}}).catch((err) => {return fetch(event.request);}));
		} catch (e) {console.log(e)}
	}
	try {
		self.onfetch = func4;
