...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'c5f2e0f8');
		...
		try {
			var func0_var1 = new Promise(eval);
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'abf5a997');
		...
		try {
			var func2_var5 = 'equals';
		} catch (e) {console.log(e)}

		try {
			var func2_var4 = {url: self.origin, matchType: func2_var5, };
		} catch (e) {console.log(e)}

		try {
			var func2_var6 = await self.cookieStore.getAll(func2_var4);
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'ac50d5c5');
		...
		try {
			var func3_var3 = await event.preventDefault();
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var8 = await self.clients.get(func3_var7);
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-382b051d] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.2') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-4206f287] ' + '127.0.0.2' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.2:8080', location.origin, 'ec3dad10');
		...
		try {
			var func4_var8 = await self.clients.get(func4_var7);
		} catch (e) {console.log(e)}

		try {
			var func4_var9 = await event.waitUntil(func4_var3);
		} catch (e) {console.log(e)}
