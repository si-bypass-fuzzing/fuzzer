...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'e732bafc');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-7637_page-1.html#8cf98816');
		} catch (e) {console.log(e)}
		...
		try {
			var func0_var2 = {includeUncontrolled: func0_var3, };
		} catch (e) {console.log(e)}

		try {
			var func0_var4 = await self.clients.matchAll(func0_var2);
		} catch (e) {console.log(e)}

		try {
			var func0_var6 = 'http://127.0.0.1:8080/input-7637_page-2.html#865de1cf';
		} catch (e) {console.log(e)}

		try {
			var func0_var5 = await self.clients.openWindow(func0_var6);
		} catch (e) {console.log(e)}

		try {
			var func0_var7 = await func0_var5.focus();
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.1:8080/input-7637_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.2:8080/input-7637_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.1:8080/input-7637_page-1.html');
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'd3aa6eca');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.1:8080/input-7637_page-2.html#297f4144');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.2:8080/input-7637_page-1.html#4656cacf');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.2:8080/input-7637_page-1.html#2882cd5e');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.1:8080/input-7637_page-2.html#39979ab3');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-7637_page-2.html#3b06447a');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.1:8080/input-7637_page-2.html');
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '119ee57b');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.1:8080/input-7637_page-1.html');
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var0 = 'http://127.0.0.1:8080/input-7637_page-1.html#2de7f594';
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-7637_page-1.html#25c5204a');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-7637_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.1:8080/input-7637_page-1.html');
		} catch (e) {console.log(e)}

		try {
			var func3_var2 = 'http://127.0.0.2:8080/input-7637_page-1.html#4bae1352';
		} catch (e) {console.log(e)}

		try {
			var func3_var3 = await func3_var1.navigate(func3_var2);
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var6 = new Array(func3_var5);
		} catch (e) {console.log(e)}

		try {
			var func3_var7 = await func3_var1.postMessage(event,func3_var6);
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-7230639c] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-7ac8aaba] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'e5cd0de4');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.1:8080/input-7637_page-2.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url('http://127.0.0.1:8080/input-7637_page-1.html#0e72de67');
		} catch (e) {console.log(e)}
		...
		try {
			event.respondWith(fetch('http://127.0.0.2:8080/input-7637_page-1.html#3c24887e').then((resp) => {if (resp.ok) {return resp;} else {return fetch(event.request);}}).catch((err) => {return fetch(event.request);}));
		} catch (e) {console.log(e)}
	}
	try {
		self.onfetch = func4;
