...
async function func0(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '194599a5');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-7642_page-1.html#3294711d');
		} catch (e) {console.log(e)}
...
async function func1(event) {
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '1500f651');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key('http://127.0.0.1:8080/input-7642_page-1.html#e6b733a3');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.1:8080/input-7642_page-1.html');
		} catch (e) {console.log(e)}
...
async function func2(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, 'a9b527c6');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.1:8080/input-7642_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-7642_page-1.html#1fc0a5d3');
		} catch (e) {console.log(e)}
		...
		try {
			var func2_var1 = 'http://127.0.0.2:8080/input-7642_page-2.html#6f8d654c';
		} catch (e) {console.log(e)}
...
async function func3(event) {
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '46724669');

		} catch (e) {console.log(e)}

async function func3_func0(event) {
			try {
				check_site_violation('http://127.0.0.1:8080', location.origin, '45cc501d');

			} catch (e) {console.log(e)}

			try {
				var func3_func0_var0 = 'foo';
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var1 = await self.cookieStore.get(func3_func0_var0);
			} catch (e) {console.log(e)}
			...
			try {
				IPCFuzzer.mutate_site_for_cookies_replace_host('http://127.0.0.2:8080/input-7642_page-2.html');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.2:8080/input-7642_page-2.html');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.1:8080/input-7642_page-1.html');
			} catch (e) {console.log(e)}
			...
			try {
				IPCFuzzer.mutate_origin('http://127.0.0.1:8080/input-7642_page-2.html#44e7125f');
			} catch (e) {console.log(e)}

			try {
				var func3_func0_var4 = '7169';
			} catch (e) {console.log(e)}
			...
			try {
				IPCFuzzer.mutate_url('http://127.0.0.1:8080/input-7642_page-2.html#f430d729');
			} catch (e) {console.log(e)}

			try {
				IPCFuzzer.mutate_schemeful_site('http://127.0.0.2:8080/input-7642_page-2.html#cea5edf5');
			} catch (e) {console.log(e)}
		...
		try {
			self.onnotificationclick = func3_func0;
		} catch (e) {console.log(e)}
		...
		try {
			var func3_var1 = new Array(event);
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_origin('http://127.0.0.2:8080/input-7642_page-2.html#de5ae026');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_origin_replace_host('http://127.0.0.2:8080/input-7642_page-2.html');
		} catch (e) {console.log(e)}
...
async function func4(event) {
        ...
        if (splitPair[0] == 'sanitize' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-f2ff3ecf] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
		if (splitPair[0] == 'sanitize_partitioned' && splitPair[1] != '127.0.0.1') {
            console.log('[UXSS] [sw-intercept-cookie-partitioned-0831bf60] ' + '127.0.0.1' + ' ' + splitPair[1]);
        }
	}
		...
		try {
			check_site_violation('http://127.0.0.1:8080', location.origin, '72e83d40');

		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_site_for_cookies('http://127.0.0.2:8080/input-7642_page-2.html#6b1303b8');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_schemeful_site_replace_host('http://127.0.0.2:8080/input-7642_page-1.html');
		} catch (e) {console.log(e)}

		try {
			IPCFuzzer.mutate_storage_key_replace_host('http://127.0.0.2:8080/input-7642_page-2.html');
		} catch (e) {console.log(e)}
		...
		try {
			IPCFuzzer.mutate_url_replace_host('http://127.0.0.2:8080/input-7642_page-2.html');
		} catch (e) {console.log(e)}
		...
		try {
			var func4_var4 = await event.stopPropagation();
		} catch (e) {console.log(e)}
